    ...
    <?php if(Auth::user()->getMenu('Students', 'module_name')): ?>
        <li class="menu-item <?php echo e(Session::get('activemenu') == 'student' ? 'active open' : ''); ?>">
            ...
            <ul class="menu-sub">
				...
				<?php if(Auth::user()->getMenu('studentXlUpload', 'name') && Auth::user()->is_view_user == 0): ?>
                    <li class="menu-item <?php echo e(Session::get('activesubmenu') == 'spu' ? 'highlight blink' : ''); ?>">
                        <a href="<?php echo e(route('studentPIDUpload')); ?>" class="menu-link">
    ...
    <?php if(Auth::user()->getMenu('Admission', 'module_name')): ?>
        <li class="menu-item <?php echo e(Session::get('activemenu') == 'admission' ? 'active open' : ''); ?>">
            ...
            <ul class="menu-sub">
                ...
                <?php endif; ?> -->
                <?php if(Auth::user()->getMenu('admissionstatus', 'name')): ?>
                    <li class="menu-item <?php echo e(Session::get('activesubmenu') == 'cas' ? 'highlight blink' : ''); ?>">
                        <a href="<?php echo e(route('admissionstatus')); ?>" class="menu-link">
...
<?php /**PATH /var/www/vhosts/bafsdadmission.com/httpdocs/resources/views/admin/layouts/leftnav.blade.php ENDPATH**/ ?>