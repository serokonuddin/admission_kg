                                    ...
                                    <div class="row g-3">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="text" readonly="readonly" id="first_name"
                                                name="first_name" value="<?php echo e($student->first_name ?? ''); ?>" required
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="date" id="birthdate" name="birthdate"
                                                placeholder="Birth Date" value="<?php echo e($student->birthdate ?? ''); ?>">
                                        ...
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <input class="form-control" type="text" id="father_name"
                                                ...
                                                value="<?php echo e($student->father_name ?? ''); ?>" autofocus="">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <img src="<?php echo e($student->father_nid ?? ''); ?>" id="father_nid_preview"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <img src="<?php echo e($student->mother_nid ?? ''); ?>" id="mother_nid_preview"
                                                    style="height: 100px; width: auto" />
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <img src="<?php echo e($student->birth_certificate ?? ''); ?>"
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                <div class="col-12 d-flex justify-content-between">
                                                    <a href="<?php echo e(url('admin/studentPrint/' . $student->student_code)); ?>"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <?php $__currentLoopData = $optionalsubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-check form-check-<?php echo e($colors[2]); ?> ">
                                                    ...
                                                    <label class="form-check-label" for="customRadio<?php echo e($colors[2]); ?>">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            <label for="father_email" class="form-label">Registration Number<span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control" type="number" id="registration_number"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <img src="<?php echo e($student->testimonial ?? ''); ?>" id="testimonial_preview"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <img src="<?php echo e($student->academic_transcript ?? ''); ?>"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <img src="<?php echo e($student->admit_card ?? ''); ?>" id="admit_card_preview"
                                                    style="height: 100px; width: 100px;" />
                                            </div>
                                        </div>
                                ...
                                <div id="social-links" class="content">
                                    ...
                                    <div class="row g-3  <?php echo e(isset($student) && $student->categoryid == 2 ? 'show' : 'hide'); ?>"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                placeholder="Name of service holder" value="<?php echo e($student->name ?? ''); ?>">
                                        </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <img src="<?php echo e($student->arm_certification ?? ''); ?>"
                                    ...
                                    <div class="row g-3 <?php echo e(isset($student) && $student->categoryid == 3 ? 'show' : 'hide'); ?>"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                <img src="<?php echo e($student->staff_certification ?? ''); ?>"
                                ...
                                <div id="review-submit" class="content">
                                    ...
                                    <div class="row g-3">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select <?php if(Auth::user()->group_id == 4): ?> disabled="disabled" <?php endif; ?>
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select id="group_id"
                                                <?php if(Auth::user()->group_id == 4): ?> disabled="disabled" <?php endif; ?>
                                                name="group_id" class=" form-select" required="">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/bafsdadmission.com/httpdocs/resources/views/student/studentAdmissionNewAdmin.blade.php ENDPATH**/ ?>