                ...
                <div style="padding: 2px .5px 2px 4px">
                    ...
                    <div style="font-size: 9px; margin-top: 5px;">
                        <div style="float:left; width:57%; text-align:left;">
                            <strong>&nbsp;Group:</strong> <?php echo e($student['activity']['group']['group_name']); ?>

                        </div>
                        <div style="float:left; width:40%; text-align:left;">
                            <strong>Section:</strong> <?php echo e($student['activity']['section']['section_name']); ?>
                    ...
                    <div style="font-size: 9px; margin-top: 5px;">
                        <div style="float:left; width:55%; text-align:left;">
                            <strong>&nbsp;Version:</strong> <?php echo e($student['activity']['version']['version_name']); ?>
...
<?php /**PATH /var/www/vhosts/bafsdadmission.com/httpdocs/resources/views/student/cardD.blade.php ENDPATH**/ ?>