            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-sm-12 col-md-12">
                        <div class="dataTables_length" id="DataTables_Table_0_length" style="padding: 5px">
                            <form action="<?php echo e(route('showStudentCounts')); ?>" method="GET">
                                    ...
                                    <div class="col-sm-3">
                                        <label class="form-label">
                                            <select id="class" name="class_id" id="class_id" class="form-select">
                                                ...
                                                <option value="0"
                                                    <?php echo e(isset($admission) && $admission->class_id == 0 ? 'selected="selected"' : ''); ?>>
                                                    KG</option>
                                                <option value="1"
                                                    <?php echo e(isset($admission) && $admission->class_id == 1 ? 'selected="selected"' : ''); ?>>
                                                    CLass I</option>
                                                <option value="2"
                                                    <?php echo e(isset($admission) && $admission->class_id == 2 ? 'selected="selected"' : ''); ?>>
                                                    CLass II</option>
                                                <option value="3"
                                                    <?php echo e(isset($admission) && $admission->class_id == 3 ? 'selected="selected"' : ''); ?>>
                                                    CLass III</option>
                                                <option value="4"
                                                    <?php echo e(isset($admission) && $admission->class_id == 4 ? 'selected="selected"' : ''); ?>>
                                                    CLass IV</option>
                                                <option value="5"
                                                    <?php echo e(isset($admission) && $admission->class_id == 5 ? 'selected="selected"' : ''); ?>>
                                                    CLass V</option>
                                                <option value="6"
                                                    <?php echo e(isset($admission) && $admission->class_id == 6 ? 'selected="selected"' : ''); ?>>
                                                    CLass VI</option>
                                                <option value="7"
                                                    <?php echo e(isset($admission) && $admission->class_id == 7 ? 'selected="selected"' : ''); ?>>
                                                    CLass VII</option>
                                                <option value="8"
                                                    <?php echo e(isset($admission) && $admission->class_id == 8 ? 'selected="selected"' : ''); ?>>
                                                    CLass VIII</option>
                                                <option value="9"
                                                    <?php echo e(isset($admission) && $admission->class_id == 9 ? 'selected="selected"' : ''); ?>>
                                                    CLass IX</option>
                                                <option value="10"
                                                    <?php echo e(isset($admission) && $admission->class_id == 10 ? 'selected="selected"' : ''); ?>>
                                                    CLass X</option>
                                                <option value="11"
                                                    <?php echo e(isset($admission) && $admission->class_id == 11 ? 'selected="selected"' : ''); ?>>
                                                    CLass XI</option>
                                                <option value="12"
                                                    <?php echo e(isset($admission) && $admission->class_id == 12 ? 'selected="selected"' : ''); ?>>
                                                    CLass XII</option>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <?php $__currentLoopData = $versiondata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j => $version): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $totals = 0;
                                $males = 0;
                                $females = 0;
                            ...
                            <?php $__currentLoopData = $version; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-sm-12">
                                    <table class="table"
                                ...
                                <?php $__currentLoopData = $shift; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key11 => $classess): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-sm-6">
                                        <div class="table-responsive">
                                            <table class="table"
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $classess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <?php if($key == 0): ?>
                                                                <td rowspan="<?php echo e(count($classess)); ?>"
                                                                    style="border: 1px solid #ddd; text-align: center;">
                                                                    <?php echo e($classroman[$student->class_code]); ?>
                                                            ...
                                                            <td style="border: 1px solid #ddd; text-align: center;">
                                                                <?php echo e($student->male_count); ?></td>
                                                            <td style="border: 1px solid #ddd; text-align: center;">
                                                                <?php echo e($student->female_count); ?></td>
                                                            <td style="border: 1px solid #ddd; text-align: center;">
                                                                <?php echo e($total); ?></td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tfoot>
                                                    <tr style="background-color: #E67E22; color: white; font-weight: bold;">
                                                        ...
                                                        <td style="border: 1px solid #ddd; text-align: center;">
                                                            <?php echo e(collect($classess)->sum('male_count')); ?></td>
                                                        <td style="border: 1px solid #ddd; text-align: center;">
                                                            <?php echo e(collect($classess)->sum('female_count')); ?></td>
                                                        <td style="border: 1px solid #ddd; text-align: center;">
                                                            <?php echo e(collect($classess)->sum('male_count') + collect($classess)->sum('female_count')); ?>
                            ...
                            <table class="table table-bordered">
                                <thead style="background-color: #3e9bd1; color: white;">
                                    ...
                                    <tr>
                                        ...
                                        <td>Total: <?php echo e($male + $female); ?></td>
                                        <td>Male: <?php echo e($male); ?></td>
                                        <td>Female: <?php echo e($female); ?></td>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select class="form-select form-control" required="" id="gender" name="gender"
                                    ...
                                    <option value="1" <?php echo e(old('gender') == 1 ? 'selected="selected"' : ''); ?>>Male
                                    </option>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/bafsdadmission.com/httpdocs/resources/views/admission/kglist.blade.php ENDPATH**/ ?>