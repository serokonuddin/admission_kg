                ...
                <div class="col-sm-12 col-md-12">
                    <div class="dataTables_length" id="DataTables_Table_0_length" style="padding: 5px">
                        ...
                        <div class="row  searchby">
                            ...
                            <div class="col-sm-6">
                                <div class="col-md">
                                    <div class="form-check">
                                        <input name="watting" id="watting" class="form-check-input" type="checkbox" value="1">
                            ...
                            <div class="col-sm-12">
                                <label class="form-label">
                                    <input type="text" name="mobile" id="mobile" class="form-control"
                                        placeholder="Search By name, mobile, birth registration no, serial no">
                                </label>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <img src="<?php echo e(asset('public/logo/logo.png')); ?>" style="display: none;" class="logo-spging" width="150">
                            </div>
                        </div>
...
function showlist(){
        ...
        var url="<?php echo e(route('ajaxLottery')); ?>";
        $.ajax({
                            type: "post",
                            headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                            url: url,
                            data:{"_token": "<?php echo e(csrf_token()); ?>",mobile,watting,session_id,version_id,shift_id},
...
$(document).ready(function() {
    ...
    $('.start-lottery').on('click', function() {
        ...
        let watting = $('#watting').is(':checked') ? $('#watting').val() : 0;
        var url="<?php echo e(route('ajaxWinnerLottery')); ?>";
        $.ajax({
                type: "post",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                url: url,
                data:{"_token": "<?php echo e(csrf_token()); ?>",session_id,watting,version_id,shift_id},
                success: function(response){
	...
	$(document.body).on('change','.category',function(){
         ...
         $.ajax({
                ...
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                url: url,
                data:{"_token": "<?php echo e(csrf_token()); ?>",category_id},
                success: function(response){
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/kgadmission/resources/views/admission/lottery.blade.php ENDPATH**/ ?>