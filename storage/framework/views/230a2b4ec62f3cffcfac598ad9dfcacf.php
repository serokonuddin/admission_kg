<?php $__env->startSection('content'); ?>
            ...
            <div class="card">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="dataTables_length" id="DataTables_Table_0_length" style="padding: 5px">
                            <form action="<?php echo e(route('kgAdmitList')); ?>" method="GET">
                                    ...
                                    <div class="col-sm-3">
                                        <label class="form-label">
                                            <input type="text" name="temporary_id" class="form-control" id="temporary_id"
                                                value="<?php echo e($temporary_id); ?>" placeholder="Search by Temp ID">
                                        </label>
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="form-label">
                                            <input type="text" name="birth_registration_number" class="form-control"
                                                id="birth_registration_number" value="<?php echo e($birth_registration_number); ?>"
                                    ...
                                    <div class="col-sm-3">
                                        <label class="form-label">
                                            <input type="text" name="mobile" class="form-control" id="mobile"
                                                value="<?php echo e($mobile); ?>" placeholder="Mobile">
                                        </label>
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="form-label">
                                            <select id="category_id" name="category_id" class="form-select">
                                                ...
                                                <option value="1" <?php echo e($category_id == 1 ? 'selected' : ''); ?>>Civil
                                                </option>
                                                <option value="2" <?php echo e($category_id == 2 ? 'selected' : ''); ?>>BAF
                                                </option>
                                                <option value="3" <?php echo e($category_id == 3 ? 'selected' : ''); ?>>SD
                                                </option>
                                                <option value="4" <?php echo e($category_id == 4 ? 'selected' : ''); ?>>GEN
                                                </option>
                                            </select>
                                        </label>
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="form-label">
                                            <input type="text" name="text_search" class="form-control" id="text_search"
                                                value="<?php echo e($text_search); ?>" placeholder="Search by name, ID, mobile">
                                        </label>
                                    </div>
                                    <div class="col-sm-3">
                                        <label>
                ...
                <div class="table-responsive">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($student->temporary_id ?? ''); ?></td>
                                    <td>
                                        <?php switch($student->category_id):
                                            case (1): ?>
                                                Civil
                                            <?php break; ?>
                                    ...
                                    <td><?php echo e($student->version_id == 1 ? 'Bangla' : 'English'); ?></td>
                                    <td><?php echo e($student->shift_id == 1 ? 'Morning' : 'Day'); ?></td>
                                    ...
                                    <td><?php echo e($student->payment_status == 1 ? 'success' : 'Unsuccess'); ?></td>
                                    <td>
                                        <button class="btn btn-primary btn-sm"
                                            onclick="sendSMS('<?php echo e($student->id); ?>')">SMS</button>
                                        <button class="btn btn-secondary btn-sm kgadmission" data-id="<?php echo e($student->id); ?>"
                                            data-session_id="<?php echo e($student->session_id); ?>"
                                            data-version_id="<?php echo e($student->version_id); ?>"
                                            data-shift_id="<?php echo e($student->shift_id); ?>"
                                            data-class_id="<?php echo e($student->class_id); ?>"
                                            data-category_id="<?php echo e($student->category_id); ?>"
                                            data-temporary_id="<?php echo e($student->temporary_id); ?>"
                                            data-service_holder_name="<?php echo e($student->service_holder_name); ?>"
                                            data-service_name="<?php echo e($student->service_name); ?>"
                                            data-name_of_service="<?php echo e($student->name_of_service); ?>"
                                            data-in_service="<?php echo e($student->in_service); ?>"
                                            data-office_address="<?php echo e($student->office_address); ?>"
                                            data-name_of_staff="<?php echo e($student->name_of_staff); ?>"
                                            data-staff_designation="<?php echo e($student->staff_designation); ?>"
                                            data-staff_id="<?php echo e($student->staff_id); ?>"
                                            data-staff_certification="<?php echo e($student->staff_certification); ?>"
                                            data-arm_certification="<?php echo e($student->arm_certification); ?>"
                                            data-gen_id="<?php echo e($student->gen_id); ?>" data-section="<?php echo e($student->section); ?>"
                                            data-name_en="<?php echo e($student->name_en); ?>"
                                            data-name_bn="<?php echo e($student->name_bn); ?>" data-dob="<?php echo e($student->dob); ?>"
                                            data-gender="<?php echo e($student->gender); ?>"
                                            data-gurdian_name="<?php echo e($student->gurdian_name); ?>"
                                            data-mobile="<?php echo e($student->mobile); ?>"
                                            data-birth_registration_number="<?php echo e($student->birth_registration_number); ?>"
                                            data-birth_image="<?php echo e($student->birth_image); ?>"
                                            data-photo="<?php echo e($student->photo); ?>"
                                            data-payment_status="<?php echo e($student->payment_status); ?>">Edit</button>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    ...
                    <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_3_paginate"
                        style="padding: 10px">
                        <?php echo e($students->appends(request()->query())->links('pagination')); ?>
        ...
        <div class="modal fade" id="exampleModalLong" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content p-4">
                    ...
                    <form action="<?php echo e(route('admissionupdate')); ?>" method="POST" enctype="multipart/form-data"
                        id="checkstatusform">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="noborder width-100">
                                    <tr>
                                        <?php if(isset($categories[0]->id)): ?>
                                        <td>
                                            <div class="form-check d-flex">
                                                <input class="form-check-input category" required="" type="radio"
                                                    name="category_id" id="<?php echo e($categories[0]->id); ?>" value="<?php echo e($categories[0]->id); ?>" checked="">
                                                <label class="form-check-label" for="<?php echo e($categories[0]->id); ?>">
                                                    &nbsp;<?php echo e($categories[0]->category_name); ?>

                                                </label>
                                            </div>
                                        </td>
                                        <?php endif; ?>
                                         <?php if(isset($categories[1]->id)): ?>
                                        <td>
                                            <div class="form-check d-flex">
                                                <input class="form-check-input category" required="" type="radio"
                                                    name="category_id" id="<?php echo e($categories[1]->id); ?>" value="<?php echo e($categories[1]->id); ?>" checked="">
                                                <label class="form-check-label" for="<?php echo e($categories[1]->id); ?>">
                                                    &nbsp;<?php echo e($categories[1]->category_name); ?>
                                    ...
                                    <tr>
                                        <?php if(isset($categories[2]->id)): ?>
                                        <td>
                                            <div class="form-check d-flex">
                                                <input class="form-check-input category" required="" type="radio"
                                                    name="category_id" id="<?php echo e($categories[2]->id); ?>" value="<?php echo e($categories[2]->id); ?>" checked="">
                                                <label class="form-check-label" for="<?php echo e($categories[2]->id); ?>">
                                                    &nbsp;<?php echo e($categories[2]->category_name); ?>

                                                </label>
                                            </div>
                                        </td>
                                        <?php endif; ?>
                                        <?php if(isset($categories[3]->id)): ?>
                                        <td>
                                            <div class="form-check d-flex">
                                                <input class="form-check-input category" required="" type="radio"
                                                    name="category_id" id="<?php echo e($categories[3]->id); ?>" value="<?php echo e($categories[3]->id); ?>" checked="">
                                                <label class="form-check-label" for="<?php echo e($categories[3]->id); ?>">
                                                    &nbsp;<?php echo e($categories[3]->category_name); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="<?php echo e(old('name_en')); ?>"
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" required="" value="<?php echo e(old('name_bn')); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputEmail4">Candidate's Date Of Birth<span style="color: red">*</span><span
                                        id="age"></span></label>
                                <input type="date" class="form-control" required="" value="<?php echo e(old('dob')); ?>"
                            ...
                            <div class="col">
                                ...
                                <select class="form-select form-control" required="" id="gender" name="gender"
                                    ...
                                    <option value="1" <?php echo e(old('gender') == 1 ? 'selected="selected"' : ''); ?>>Male</option>
                                    <option value="2" <?php echo e(old('gender') == 2 ? 'selected="selected"' : ''); ?>>Female
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" required=""
                                    value="<?php echo e(old('gurdian_name')); ?>" id="gurdian_name" name="gurdian_name"
                                    placeholder="Gurdian Name">
                            </div>
                            <div class="col">
                                <label for="inputEmail4">Mobile Number<span style="color: red">*</span></label>
                                <input type="text" class="form-control" required="" value="<?php echo e(old('mobile')); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('birth_registration_number')); ?>" id="birth_registration_number1"
    ...
    <!-- <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="editForm" method="POST" action="<?php echo e(route('admission.update')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        function sendSMS(id) {
            var url = "<?php echo e(route('sendSmsForTemporaryID')); ?>";
            Swal.fire({
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/kgadmission/resources/views/admission/kgAdmissionList.blade.php ENDPATH**/ ?>