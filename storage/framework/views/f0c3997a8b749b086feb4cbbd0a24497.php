...
<div class="content-wrapper">
                          ...
                          <td>
                            <div class="dropdown">
                                 ...
                                 <div class="dropdown-menu" style="">
                                     ...
                                     data-category_name="<?php echo e($category->category_name); ?>"
                                     data-type="<?php echo e($category->type); ?>"
                                     data-active="<?php echo e($category->active); ?>"
                                     href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                     <a class="dropdown-item delete" data-url="<?php echo e(route('category.destroy', $category->id)); ?>" data-id="<?php echo e($category->id); ?>"  href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Delete</a>
                                 </div>
                             </div>
                           </td>
                          <?php endif; ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation" method="post" action="<?php echo e(route('category.store')); ?>" novalidate=""
                id="formsubmit">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/kgadmission/resources/views/setting/category.blade.php ENDPATH**/ ?>