            ...
            <div class="container spaceb50">
               <div class="row">
                  ...
                  <div class="refine-categ-header " style="margin-top: 10px;">
                     ...
                     <h4 style="text-align: center"> <img title="Hotline Number" src="<?php echo e(asset('public/call-thumbnail.png')); ?>" style="height: 25px" /> <a href="tel:01759536622" style="color: red;font-weight: bold;">01759536622, </a><a href="tel:01777521159" style="color: red;font-weight: bold;">01777521159</a> </h4>
                        ...
                        <div class="container">
                           <div class="row wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                              ...
                              <div class="col-sm-3">
                                 ...
                                 <div class="card <?php if($admission->version_id==1): ?> bg-danger <?php else: ?> bg-success <?php endif; ?> card-hover" style="min-height: 164px"><a href="#gallery_home">
                                    </a>
                                    <div class="card-body text-center p-0"><a href="#gallery_home">
                                          <div class="card-icon-border-large  <?php if($admission->version_id==1): ?> border-danger <?php else: ?> border-success <?php endif; ?> ">
                                             <?php if($admission->version_id==1): ?> BN <?php else: ?> EN <?php endif; ?>
                                          </div>
                                          <p class="text-white  font-dosis">Last date <?php echo e(date("M j, Y", strtotime($admission->end_date))); ?>

                                          </p>
                                       </a>
                                       <button type="button" class="btn <?php if($admission->version_id==1): ?> btn-success <?php else: ?> btn-danger <?php endif; ?> kgadmission"
                                          data-versionid="<?php echo e($admission->version_id); ?>"
                                          data-class_id="<?php echo e($admission->class_id); ?>"
                                          data-session_id="<?php echo e($admission->session_id); ?>"
                                          data-amount="<?php echo e($admission->price); ?>" fdprocessedid="fyjlka">
                                          Apply Now
                                       </button>
...
<div class="modal fade mb-8" id="exampleModalLong" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form action="<?php echo e(route('admissionstore')); ?>" method="post" enctype="multipart/form-data" class="onlineform" id="checkstatusform">
            <div class="modal-body">
                  ...
                  <div class="col-md-12">
                     <table class="noborder width-100">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="form-check d-flex">
                                 <input class="form-check-input category" required="" type="radio" name="category_id" id="<?php echo e($categories[0]->id); ?>" value="<?php echo e($categories[0]->id); ?>" checked="">
                           ...
                           <td>
                              <div class="form-check d-flex">
                                 <input class="form-check-input category" required="" type="radio" name="category_id" id="<?php echo e($categories[1]->id); ?>" value="<?php echo e($categories[1]->id); ?>" >
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="form-check d-flex">
                                 <input class="form-check-input category" required="" type="radio" name="category_id" id="<?php echo e($categories[2]->id); ?>" value="<?php echo e($categories[2]->id); ?>" >
                           ...
                           <td>
                              <div class="form-check d-flex">
                                 <input class="form-check-input category" required="" type="radio" name="category_id" id="<?php echo e($categories[3]->id); ?>" value="<?php echo e($categories[3]->id); ?>" >
               ...
               <div class="row">
                  ...
                  <div class="col">
                     ...
                     <input type="text" class="form-control" value="<?php echo e(old('name_en')); ?>" style="text-transform:uppercase" required="" name="name_en" placeholder="English Name">
                  </div>
                  <div class="col">
                     <label for="inputEmail4">প্রার্থীর বাংলা নাম<span style="color: red">*</span></label>
                     <input type="text" class="form-control" required="" value="<?php echo e(old('name_bn')); ?>" name="name_bn" placeholder="Bangla Name">
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col">
                     ...
                     <input type="date" class="form-control" required="" value="<?php echo e(old('dob')); ?>" id="dob" name="dob" placeholder="Date of Birth">
                  ...
                  <div class="col">
                     ...
                     <select class="form-select form-control" required="" name="gender" aria-label="Default select example">
                        ...
                        <option value="2" <?php echo e((old('gender')==2)?'selected="selected"':''); ?>>Female</option>
                     </select>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col">
                     ...
                     <input type="text" class="form-control" required="" value="<?php echo e(old('gurdian_name')); ?>" name="gurdian_name" placeholder="Gurdian Name">
                  </div>
                  <div class="col">
                     <label for="inputEmail4">Mobile Number<span style="color: red">*</span></label>
                     <input type="text" class="form-control" required="" value="<?php echo e(old('mobile')); ?>" name="mobile" placeholder="Mobile">
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col">
                     ...
                     <input type="text" class="form-control" value="<?php echo e(old('birth_registration_number')); ?>" required="" name="birth_registration_number" placeholder="Birth Registration Number">
                  </div>
                  <div class="col">
...
<div class="modal fade mb-8" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form action="<?php echo e(route('admissionsearch')); ?>" method="post" enctype="multipart/form-data" class="onlineform" id="checkstatusform">
            <div class="modal-body">
               <input type="hidden" name="_token" id="csrf-token" value="<?php echo e(Session::token()); ?>" />
               ...
               <div class="row">
                  ...
                  <div class="col">
                     ...
                     <input type="text" class="form-control" value="<?php echo e(old('temporary_id')); ?>" style="text-transform:uppercase" required="" name="temporary_id" placeholder="Temporary ID">
                  </div>
                  <div class="col">
...
<div id="checkOnlineAdmissionStatus" class="modal fade" role="dialog" tabindex="-1">
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         ...
         <form action="<?php echo e(route('admissionData')); ?>" method="post" enctype="multipart/form-data" class="onlineform" id="checkstatusform">
            <input type="hidden" name="_token" id="csrf-token" value="<?php echo e(Session::token()); ?>" />
...
<?php echo $__env->make('frontend-new.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/kgadmission/resources/views/frontend-new/admissionlist.blade.php ENDPATH**/ ?>