...
class EmisChargeController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $classwiseemischarge=ClassCategoryHeadFee::with([
            ...
            ,'category'
            ,'head'
       ])->where('head_id',34)->where('session_id',$session->id)->get();
       ...
       foreach($classwiseemischarge as $key=>$values){
        ...
        return view('emischarge.index',compact('feehead','sessions','classes','emisdata','emisdatadate','emisdataid'));
    }
