            ...
            if ($validation) {
                ...
                */
                ...
                if ($order_details->class_code == 0) {
                    ...
                    sms_send($admission->mobile, 'KG Admission payment for BAF Shaheen college Dhaka is completed.Your Temporay Number is ' . $temporay_id . '. Please Collect Your Admit Card Link: https://bafsd.edu.bd/admissionview');
                ...
                sms_send($admission->phone, 'Admission payment for BAF Shaheen college Dhaka is completed. Please login and fill up your admission form. Usermame: ' . $admission->username . ', Password: ' . $password . '. Link: https://bafsdadmission.com/login');
                $text = "Admission payment for BAF Shaheen college Dhaka is completed. Please login and fill up your admission form.";
                return redirect()->route('sslredirect')->with('warging', $text);
            }
