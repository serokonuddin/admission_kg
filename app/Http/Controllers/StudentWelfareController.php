...
class StudentWelfareController extends Controller
{
    ...
    public function index()
    {
        ...
        $fees=Fee::join('master_category_wise_head_mapping','master_category_wise_head_mapping.head_id','=','fee_head.id')
                ->orderBy('master_category_wise_head_mapping.id','desc')->get();
       ...
       $payments= $payments->orderBy('id','desc')->get();
        return view('fee.studentWelfare.index',compact('fees','sessions','versions','categories','payments'));
    }
