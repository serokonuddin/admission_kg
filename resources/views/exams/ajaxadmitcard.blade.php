            ...
            <div id="AdmitCardPrintDiv">
                ...
                <div class="AdmitCard">
                    ...
                    @foreach ($students as $key => $student)
                        ...
                        <hr
                            style="margin-top: 5px; margin-bottom: {{ $class_code < 9 && $loop->iteration % 2 === 1 && !$loop->last ? '30px' : '10px' }}" />
                        {{-- <p style="page-break-before: always;"></p> --}}
                        {{-- Show dashed line unless it's the last student --}}
                        @if ($class_code < 11 && $loop->iteration % 2 === 1 && !$loop->last)
...
<script>
    function printElem(divId) {
        ...
        mywindow.document.write('<style> @page { size: 210mm 297mm; margin: 15mm 5mm 0mm 5mm; } </style>');
