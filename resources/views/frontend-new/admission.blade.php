                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <label>Board (বোর্ড)</label><small class="req"> *</small>
                                        <select class="form-control" name="board_id" id="board_id">
                                            ...
                                            <option value="Rajshahi" {{(strtolower($checkadmission->board)=='rajshahi')?'selected="selected"':''}}>Rajshahi (রাজশাহী)</option>
                                            <option value="Cumilla" {{(strtolower($checkadmission->board)=='cumilla')?'selected="selected"':''}}>Cumilla (কুমিল্লা)</option>
                                            <option value="Jashore
" {{(strtolower($checkadmission->board)=='jashore')?'selected="selected"':''}}>Jashore (যশোর)</option>
                                            <option value="Chattogram
" {{(strtolower($checkadmission->board)=='chattogram')?'selected="selected"':''}}>Chattogram
 (চট্টগ্রাম)</option>
                                            <option value="Barishal" {{(strtolower($checkadmission->board)=='barishal')?'selected="selected"':''}}>Barishal (বরিশাল)</option>
                                            ...
                                            <option value="Madrasah" {{(strtolower($checkadmission->board)=='madrasah')?'selected="selected"':''}}>Madrasah (মাদ্রাসা)</option>
											<option {{(strtolower($checkadmission->board)=='mymensingh')?'selected="selected"':''}} value="Mymensingh">Mymensingh (ময়মনসিংহ)</option>
                                            <option value="BTEB" {{(strtolower($checkadmission->board)=='bteb')?'selected="selected"':''}}>Bangladesh Technical Education (বাংলাদেশ কারিগরি শিক্ষা বোর্ড)</option>
                                ...
                                <!-- <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <label>Username (ইউজার নাম)</label><small class="req"> *</small>
                                            <input type="text" readonly="readonly" value="{{$checkadmission->student_code}}" class="form-control" placeholder="Valid Email,phone or username. Username should not contain spaces and spacial character" required="" name="username" id="username" autocomplete="off">
