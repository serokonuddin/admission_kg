                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style="padding-bottom: 10px;">
                                                ...
                                                <input type="text" class="form-control" id="temporary_id"
                                                    value="{{ old('temporary_id') }}" required="" name="temporary_id"
                                            ...
                                            {{-- <div class="col-md-6" style="padding-bottom: 10px;">
                                                <button type="button" class="btn btn-primary findAdmitcard"
                                                    style="background-color: #00ADEF;text-align: right;margin-top: 20px;float: right">Get
                                                    Admit Card</button>
                                            </div> --}}
                                        </div>
                                        <div class="row display-none">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" readonly="" class="form-control"
                                                    value="{{ old('version_name') }}" required="" id="version_name"
                                            ...
                                            <div class="col">
                                                <label for="inputEmail4">Shift (শিফট)<span
                                                        style="color: red">*</span></label>
                                                <input type="text" readonly="" class="form-control"
                                                    value="{{ old('shift_name') }}" required="" id="shift_name"
                                        ...
                                        <div class="row display-none">
                                            <div class="col">
                                                <label for="inputEmail4">Candidate's English Name<span
                                                        style="color: red">*</span></label>
                                                <input type="text" readonly="" class="form-control"
                                                    value="{{ old('name_en') }}" style="text-transform:uppercase"
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" readonly="" class="form-control" required=""
                                                    value="{{ old('name_bn') }}" id="name_bn" name="name_bn"
                                ...
                                <table class="table">
                                    <tr>
                                        <td style="text-align: center;border: none;">
                                            <a class="onlineformbtn" href="{{ route('login') }}" style="">Already
    ...
    <script>
        ...
        $(function() {
            ...
            $(document.body).on('input', '#temporary_id', function() {
                ...
                var url = "{{ route('checkTemporaryId') }}";
