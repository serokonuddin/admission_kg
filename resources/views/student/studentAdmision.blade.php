...
@section('content')
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                @foreach ($student as $stu)
                                    <a class="btn btn-primary" href="{{ route('StudentProfile', $stu->id) }}">
                        ...
                        <div class="bs-stepper wizard-icons wizard-icons-example mt-2">
                            <div class="bs-stepper-header">
                                <div class="step active text-bold " id="accountdetails">
                                    <button type="button" class="step-trigger headermenu"
                                        data-currentdata="account-details" data-pre="none" aria-selected="true">
                            ...
                            <div class="bs-stepper-content">
                                <form id="formAdmission" method="POST"
                                    @if ($student->submit != 2 || Auth::user()->group_id == 2 || Auth::user()->group_id == 5) action="{{ route('students.store') }}" @endif
                                    ...
                                    <div id="account-details" class="content active dstepper-block">
                                        <div class="content-header mb-3">
                                            <h6 class="mb-0"
                                                style="color: #da45dc;weight: bold;font-size: 16px;font-weight: bold">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="mb-3 col-md-3">
                                                ...
                                                <input class="form-control" required="" type="text"
                                                    ...
                                                    value="{{ $student->father_name ?? '' }}" autofocus="">
                                            ...
                                            <div class="mb-3 col-md-3">
                                                ...
                                                <input type="text" id="student_relation" required=""
                                            ...
                                            @if ($student->submit != 2 || Auth::user()->group_id == 2 || Auth::user()->group_id == 5)
                                                    ...
                                                    @foreach ($comsubjects as $key => $subject)
                                                        ...
                                                        <div class="form-check form-check-{{ $colors[0] }} ">
                                                            <input class="form-check-input" type="radio"
                                                                value="{{ $ids }}" id="customRadioPrimary"
                                                                checked="">
                                                            <label class="form-check-label"
                                                                for="customRadio{{ $colors[0] }}"> {{ $key }}
                                                            </label>
                                                        </div>
                                                    @endforeach
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                @foreach ($optionalsubjects as $key => $subject)
                                                    ...
                                                    <div class="form-check form-check-{{ $colors[2] }} ">
                                                        <input
                                                            class="form-check-input third_subject subject{{ $pair }}"
                                                            type="{{ $text }}" name="third_subject[]"
                                                            data-pair="{{ $pair }}" value="{{ $ids }}"
                                                            id="customRadio{{ $colors[$i] }}" {{ $checked }}>
                                                        <label class="form-check-label"
                                                            for="customRadio{{ $colors[2] }}"> {{ $key }}
                                                        </label>
                                                    </div>
                                                @endforeach
                                                ...
                                                @foreach ($fourthsubjects as $key => $subject)
                                                    ...
                                                    <div class="form-check form-check-{{ $colors[3] }} ">
                                                        <input
                                                            class="form-check-input fourth_subject subject{{ $pair }}"
                                                            type="radio" name="fourth_subject[]"
                                                            value="{{ $ids }}" data-pair="{{ $pair }}"
                                            ...
                                            @if ($student->submit != 2 || Auth::user()->group_id == 2 || Auth::user()->group_id == 5)
                                                <div class="col-12 d-flex justify-content-between">
                                                    ...
                                                    <button type="button" data-value="sscexamdetails"
                                                        ...
                                                        data-target="#address" class="btn btn-primary btn-next">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input class="form-control" type="text" id="exam_center"
                                                    ...
                                                    value="{{ $student->exam_center ?? '' }}" autofocus="">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input class="form-control" type="number" id="roll_number"
                                                    ...
                                                    value="{{ $student->roll_number ?? '' }}" autofocus="">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input class="form-control" type="number" id="total_mark"
                                                    name="total_mark" placeholder="Total Marks"
                                                    value="{{ $student->total_mark ?? '' }}" autofocus="">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    <img src="{{ $student->testimonial ?? '' }}"
                                                        id="testimonial_preview" style="height: 100px; width: 100px;" />
                                                </div>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label for="academic_transcript" class="form-label">SSC Academic
                                                    Transcript (jpg,jpeg,png format)<span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="file"
                                                ...
                                                <input class="form-control" type="hidden" id="academic_transcript_old"
                                                    value="{{ $student->academic_transcript ?? '' }}"
                                                    name="academic_transcript_old">
                                                <div class="mb-3 col-md-12">
                                                    <img src="{{ $student->academic_transcript ?? '' }}"
                                                        id="academic_transcript_preview"
                                                        style="height: 100px; width: 100px;" />
                                                </div>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input class="form-control" type="file"
                                                    ...
                                                    {{ !empty($student->admit_card) ? '' : 'required=""' }}
                                            ...
                                            @if ($student->submit != 2 || Auth::user()->group_id == 2 || Auth::user()->group_id == 5)
                                                <div class="col-12 d-flex justify-content-between">
                                                    ...
                                                    <button type="button" data-value="force"
                                                        data-currentdata="personal-info" data-pre="sscexamdetails"
                                        ...
                                        <div class="row g-3  {{ isset($student) && $student->categoryid == 2 ? 'show' : 'hide' }}"
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label for="arm_certification"
                                                    class="form-label">Certification/Testimonial from office (jpg,jpeg,png
                                    ...
                                    <div id="review-submit" class="content">
                                        <div class="content-header mb-3">
                                            <h6 class="mb-0"
                                                style="color: #da45dc;font-weight: bold;font-size: 16px;">Academic Info
                                            </h6>
                                        </div>
                                        @if (isset($activity) && $activity->class_id == 59)
                                            <input type="hidden" name="class_id"
                                                value="{{ $activity->class_id }}" />
                                            <input type="hidden" name="session_id"
                                                value="{{ $activity->session_id }}" />
                                            <input type="hidden" name="version_id"
                                                value="{{ $activity->version_id }}" />
                                        @endif
                                        <div class="row g-3">
                                            <div class="mb-3 col-md-4">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select id="version_id"
                                                    @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                    name="version_id" class=" form-select" required="">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select id="shift_id"
                                                    @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                    name="shift_id" class=" form-select" required="">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select id="class_code"
                                                    @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                    name="class_code" class=" form-select" required="">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select id="section_id"
                                                    @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                    name="section_id" class=" form-select">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select id="house_id"
                                                    @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                    name="house_id" class=" form-select">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input class="form-control"
                                                    @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                    type="text" id="roll" name="roll"
                                                    value="{{ $activity->roll ?? '' }}" placeholder="Roll"
                                                    autofocus="">
                                            </div>
                                            <div class="col-12 d-flex justify-content-between">
                                                @if ($student->submit != 2 || Auth::user()->group_id == 2 || Auth::user()->group_id == 5)
                                                    ...
                                                    <button type="button" class="btn btn-success "
                                                        id="btn-submit">Submit & Preview</button>
                                            </div>
    ...
    <div class="modal fade" id="modalScrollable" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <form id="formAdmission" method="POST"
                @if ($student->submit != 2 || Auth::user()->group_id == 2 || Auth::user()->group_id == 5) action="{{ route('storePreview') }}" @endif
                enctype="multipart/form-data">
                @csrf
