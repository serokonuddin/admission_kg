    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            {{-- <h4 class="py-3 mb-4">
                ...
                {{ $student->student_code ? 'Student Profile' : 'Student Admission Form' }}
            </h4> --}}
            <nav aria-label="breadcrumb" class="my-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ $student->student_code ? 'Student Profile' : 'Student Admission Form' }}</li>
                </ol>
            </nav>
            <!-- Default -->
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <div class="bs-stepper wizard-icons wizard-icons-example mt-2">
                        <div class="bs-stepper-header" style="z-index: 99">
                        ...
                        <div class="bs-stepper-content">
                            <form id="formAdmission" method="POST"
                                @if ($student->submit != 2) action="{{ route('studentUpdate') }}" @endif
                                    ...
                                    <div class="row g-3">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="text" id="first_name" name="first_name"
                                                ...
                                                {{ Auth::user()->group_id == 2 ? '' : 'required' }}
                                                placeholder="Student's Name (English)" autofocus=""
                                                {{ $student->first_name && Auth::user()->group_id != 2 && Auth::user()->group_id != 7 ? 'disabled' : '' }}>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="text" name="bangla_name" id="bangla_name"
                                                ...
                                                {{ $student->bangla_name && Auth::user()->group_id != 2 && Auth::user()->group_id != 7 ? 'disabled' : '' }}>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="date" id="birthdate" name="birthdate"
                                                ...
                                                {{ Auth::user()->group_id == 2 ? '' : 'required' }}
                                                {{ $student->birthdate && Auth::user()->group_id != 2 && Auth::user()->group_id != 7 ? 'disabled' : '' }}>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                {{ Auth::user()->group_id == 2 ? '' : 'required' }} id="nationality"
                                        ...
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <input class="form-control"
                                                {{ Auth::user()->group_id == 2 ? '' : 'required' }} type="text"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="number" name="sms_notification"
                                                {{ Auth::user()->group_id == 2 ? '' : 'required' }} id="sms_notification"
                                                placeholder="Please enter number"
                                                value="{{ $student->sms_notification ?? '' }}"
                                                {{ $student->sms_notification && Auth::user()->group_id != 2 && Auth::user()->group_id != 7 ? 'disabled' : '' }}>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="file" id="photo"
                                                ...
                                                {{ Auth::user()->group_id == 2 || !empty($student->photo) ? '' : 'required' }}>
                                            <span style="color: rgb(0,149,221)">(File size max 200 KB)</span>
                                        ...
                                        @elseif(Auth::user()->group_id != 2 || Auth::user()->group_id != 5 || Auth::user()->group_id != 7)
                                            <div class="col-12 d-flex justify-content-between gap-2 flex-wrap">
                                                <button class="btn btn-label-secondary btn-prev" disabled="">
                                                    <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                                                    <span
                                        ...
                                        <div class="col-md">
                                            <div class="form-check mt-3">
                                                <input name="categoryid" class="form-check-input specialinfo"
                                                    ...
                                                    {{ isset($student->categoryid) && Auth::user()->group_id != 2 ? 'disabled' : '' }}
                                ...
                                <div id="review-submit" class="content">
                                    ...
                                    <div class="row g-3">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select id="session_id"
                                                ...
                                                name="session_id" class=" form-select"
                                                {{ Auth::user()->group_id == 2 ? '' : 'required' }}>
                                                <option value="">Select Session</option>
                                                @foreach ($sessions as $key => $session)
                                                    <option value="{{ $key }}"
                                                        {{ isset($activity) && $activity->session_id == $key ? 'selected="selected"' : '' }}>
                                                        {{ $session }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select id="version_id"
                                                @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                name="version_id" class=" form-select"
                                                {{ Auth::user()->group_id == 2 ? '' : 'required' }}>
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select id="shift_id"
                                                @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                name="shift_id" class=" form-select">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select id="class_code"
                                                @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                name="class_code" class=" form-select"
                                                {{ Auth::user()->group_id == 2 ? '' : 'required' }}>
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select id="group_id" name="group_id"
                                                @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled="disabled" @endif
                                                class=" form-select" {{-- {{ Auth::user()->group_id == 2 ? '' : 'required' }} --}}>
                                        ...
                                        <div class="mb-3 col-md-4" hidden>
                                            ...
                                            <select id="section_id" @if (Auth::user()->group_id != 2 && Auth::user()->group_id != 5) disabled @endif
                                    ...
                                    @elseif(Auth::user()->group_id != 2 || Auth::user()->group_id != 5 || Auth::user()->group_id != 7)
                                        <input type="hidden" class="btn btn-warning me-2" name="submit" id="submit"
                                            value="1">
                                        <button type="button" class="btn btn-primary btn-prev">
                                            <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                                            <span class="align-middle d-sm-inline-block d-none Previous" data-next="force"
                                                data-currentdata="review-submit"
                                                data-target="#personal-info">Previous</span>
                                        </button>
                                        <!-- <button type="button" class="btn btn-info btn-save">Save</button> -->
                                        <button type="button" class="btn btn-success " id="btn-submit">Submit &
