                            ...
                            <form id="formAdmission" method="POST" action="{{ route('studentUpdate') }}"
                                    ...
                                    <div class="form-section">
                                        <div class="row g-3">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <span class="validation-message" id="nationality_error"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-section">
                                        <div class="row g-3">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <span class="validation-message" id="gender_error"></span>
                                            </div>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="row g-3">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <span class="validation-message" id="photo_error"></span>
                                            </div>
                                ...
                                <div id="personal-info" class="content">
                                    <div class="step-header">
                                        ...
                                        <small class="text-danger">Fields marked with <span class="text-danger">*</span>
                                            are mandatory and must be completed.</small>
                                    </div>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label for="guardian_email"
                                                        class="form-label required-field">Serving/Retired</label>
                                    ...
                                    <div class="row g-3 {{ isset($student) && $student->categoryid == 1 ? 'show' : 'hide' }}"
                                        ...
                                        <div class="form-section">
                                            <div class="alert alert-info">
                                                <h6 class="alert-heading">Civil Category Selected</h6>
                                                <p class="mb-0">No additional information required for this category.</p>
                                            </div>
                                        </div>
                                ...
                                <div id="review-submit" class="content">
                                    <div class="step-header">
                                        ...
                                        <small class="text-danger">Note: This information is locked and cannot be
                                            modified.</small>
                                    </div>
            ...
            <form id="formAdmission" method="POST"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalFullTitle" style="margin-left:33%;">
    ...
    <script>
        ...
        function showValidationSummary() {
            Swal.fire({
                ...
                html: "Please complete all required fields marked with <span class='text-danger'>*</span> before proceeding.",
                icon: "warning",
                confirmButtonText: "OK",
                confirmButtonColor: "#da45dc"
            });
        }
    </script>
