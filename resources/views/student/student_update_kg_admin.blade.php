                                    ...
                                    <div class="row g-3">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="text" id="first_name"
                                                {{ Auth::user()->group_id != 2 && Auth::user()->group_id != 7 && Auth::user()->group_id != 3 ? 'disabled' : '' }}
                                        ...
                                        @if ($student->submit != 2 || Auth::user()->group_id == 2 || Auth::user()->group_id == 7 || Auth::user()->group_id == 3)
                                        ...
                                        <div class="col-md">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="disabledRadio3">
                                                    Son/daughter of Teaching/Non-Teaching staff of BAFSD/SEMC
                                                </label>
                                            </div>
    ...
    <div class="modal fade" id="modalScrollable" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <form id="formAdmission" method="POST"
                @if ($student->submit != 2 || Auth::user()->group_id == 2 || Auth::user()->group_id == 7 || Auth::user()->group_id == 3) action="{{ route('storePreview') }}" @endif
                enctype="multipart/form-data">
                @csrf
