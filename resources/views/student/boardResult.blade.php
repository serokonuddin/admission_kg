...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            {{-- <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Students</h4> --}}
                ...
                <div class="row">
                    <div class="card-header">
                        <div class="dataTables_length" id="DataTables_Table_0_length" style="padding: 5px">
                            <form id="formAdmission" method="POST" action="{{ route('boardResulXlUploadSave') }}"
    ...
    <script>
        $(document.body).on('click', '#search_button', function() {
            ...
            const url = "{{ route('getBoardResults') }}";
            $.LoadingOverlay("show");
