            ...
            <nav aria-label="breadcrumb" class="my-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ $student->student_code ? 'Update Profile' : 'Student Admission Form' }}</li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-12 mb-4">
                    <div class="bs-stepper wizard-icons wizard-icons-example mt-2">
                        ...
                        <div class="bs-stepper-header">
                            <div class="step {{($student->stage==1 || $student->submit==2)?'active':''}} text-bold " id="accountdetails">
                            ...
                            <div class="step {{$student->stage==2?'active':''}}" id="desiredsubject">
                            ...
                            <div class="step {{$student->stage==3?'active':''}}" id="sscexamdetails" id="sscexam">
                            ...
                            <div class="step {{$student->stage==4?'active':''}}" id="force">
                            ...
                            <div class="step {{$student->stage==5?'active':''}}" id="academicinfo">
                        ...
                        <div class="bs-stepper-content">
                            <form id="formAdmission" method="POST" action="{{ route('students.store') }}"
                                ...
                                <!-- Account Details -->
                                <div id="account-details" class="content {{($student->stage==1 || $student->submit==2)?'active dstepper-block':''}} ">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="number" name="sms_notification"
                                                ...
                                                value="{{ $student->sms_notification ?? '' }}"
												   {{ !empty($student->sms_notification) ? 'readonly' : '' }}
												   >
...
@else
    -->
                                ...
                                <!-- Personal Info -->
                                <div id="personal-info" class="content {{($student->stage==2 || $student->submit==2)?'active dstepper-block':''}}">
                                    <div class="content-header mb-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            @foreach ($fourthsubjects as $key => $subject)
                                                ...
                                                <div class="form-check form-check-{{ $colors[3] }} ">
													@if($activity->version_id==1 && $pair=='67-68' && $ids=='71-72')
                                                    <input
										...
										@elseif($activity->group_id == 3 && $activity->version_id == 2)
											<div class="mb-3 col-md-10">
                                                <label for="first_name" class="form-label bn-node">N.B.</label><br>
                                ...
                                <!-- Address -->
                                <div id="address" class="content {{($student->stage==3 || $student->submit==2)?'active dstepper-block':''}}">
                                    <div class="content-header mb-3">
                                        <h6 class="mb-0" style="color: #da45dc;font-weight: bold;font-size: 16px;">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input class="form-control" type="number" id="total_mark" name="total_mark"
                                                placeholder="Total Marks" value="{{ $student->total_mark ?? '' }}"
                                                autofocus="">
                                        </div>
                                        <div class="mb-3 col-md-4">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input class="form-control" type="file"
                                                ...
                                                id="academic_transcript" {{-- {{ !empty($student->academic_transcript) ? '' : 'required=""' }} --}}
                                                {{ Auth::user()->group_id != 2 && Auth::user()->group_id != 7 && empty($student->academic_transcript) ? 'required' : '' }}
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input class="form-control" type="file"
                                                ...
                                                {{ Auth::user()->group_id != 2 && Auth::user()->group_id != 7 && empty($student->admit_card) ? 'required' : '' }}
                                ...
                                <!-- Social Links -->
                                <div id="social-links" class="content {{($student->stage==4 || $student->submit==2)?'active dstepper-block':''}}">
                                ...
                                <!-- Review -->
                                <div id="review-submit" class="content {{($student->stage==5 || $student->submit==2)?'active dstepper-block':''}}">
                                    <div class="content-header mb-3">
                                        <h6 class="mb-0" style="color: #da45dc;font-weight: bold;font-size: 16px;">
                                            Academic Info</h6>
                                    </div>
                                    ...
                                    @if (isset($activity) && Auth::user()->group_id == 4)
                                        <input type="hidden" name="class_id" id="class_id"
                                            value="{{ $activity->class_code }}" />
                                        ...
                                        <div class="row g-3">
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select disabled="disabled"=======<select
                                                    @if (Auth::user()->group_id == 4) disabled="disabled" @endif
...
-->
                                            ...
                                            <div class="col-12 d-flex justify-content-between">
                                              ...
                                              @if ($student->submit != 2)
                                                    <input type="hidden" class="btn btn-warning me-2" name="submit"
                                                        id="submit" value="{{$student->submit}}">
                                                    <button type="button" class="btn btn-primary btn-prev">
                                                        <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                                                        <span class="align-middle d-sm-inline-block d-none Previous"
                                                            data-next="force" data-currentdata="review-submit"
    ...
    <script>
        $(function() {
            ...
            $(document.body).on('click', '.headermenu', function() {
                ...
                var userGroupId = {{ Auth::user()->group_id }};
