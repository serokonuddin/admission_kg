        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row mt-4">
                ...
                <!-- div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-warning cursor-pointer text-center">
                        <a href="{{ route('studentAttendanceparentAttendance') }}">
                            <div class="card-body bg-label-danger">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-warning cursor-pointer text-center">
                        <a href="{{ route('calendarDashboard') }}">
                            <div class="card-body bg-label-danger">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/calendar.png') }}" alt="calendar" class="rounded">
                                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-primary cursor-pointer text-center">
                        <a href="{{ route('academyDashboard') }}">
                            <div class="card-body bg-label-primary">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/activity.png') }}" alt="syllabus" class="rounded">
                                </div>
            ...
            <div class="row mt-4">
                    ...
                    <div class="card icon-card card-border-shadow-primary cursor-pointer text-center">
                        <a href="{{ route('studentNotice') }}">
                            <div class="card-body bg-label-info">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/notice.webp') }}" alt="notice" class="rounded">
                                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-primary cursor-pointer text-center">
                        <a href="{{ route('studentSyllabus') }}">
                            <div class="card-body bg-label-primary">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/syllabus.png') }}" alt="syllabus" class="rounded">
                                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-warning cursor-pointer text-center">
                        <a href="{{ route('student.academicTranscript') }}">
                            <div class="card-body bg-label-warning">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/result.png') }}" alt="result" class="rounded">
                                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-primary cursor-pointer text-center">
                        <a href="{{ route('lessonPlanStudent') }}">
                            <div class="card-body bg-label-primary">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/lessonPlan.png') }}" alt="lessonPlan"
                                        class="rounded">
                                </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-warning cursor-pointer text-center">
                        <a href="{{ route('studentRouten') }}">
                            <div class="card-body bg-label-warning">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/routine.png') }}" alt="routine" class="rounded">
                                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-primary cursor-pointer text-center">
                        <a href="{{ route('studentPrint', Auth::user()->ref_id) }}" target="_blank">
                            <div class="card-body bg-label-info">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/admission.png') }}" alt="form"
                                        class="rounded">
                                </div>
				...
				<div class="col-sm-6 col-lg-3">
                    <div class="card icon-card card-border-shadow-primary cursor-pointer text-center">
                        <a href="{{ route('getidcardd') }}" target="_blank">
                            <div class="card-body bg-label-warning">
                                <div class="avatar flex-shrink-0 " style="margin: 0px auto">
                                    <img src="{{ asset('public/dashboard/brochure.png') }}" alt="form"
                                        class="rounded">
                                </div>
				...
				<div class="col-sm-6 col-lg-4 mt-3">
					<div class="card icon-card card-border-shadow-primary cursor-pointer text-center">
						...
						" target="_blank">
							<div class="card-body bg-label-warning">
								<div class="avatar flex-shrink-0" style="margin: 0px auto">
									<img src="{{ asset('public/dashboard/brochure.png') }}" alt="form" class="rounded">
								</div>
								<p class="icon-name text-capitalize text-truncate mb-0">Prospectus</p>
							</div>
						</a>
