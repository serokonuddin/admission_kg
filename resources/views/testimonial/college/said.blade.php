...
<body>
                ...
                <div class="panel panel-default">
                   ...
                   background-size: cover; background-position: center; background-repeat: no-repeat; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 350px; height: 350px; opacity: 0.08; z-index: 999999;">
                            ...
                            <div style="margin-bottom:20px;" class="reportDiv">
                                ...
                                <div style="float:left; width:52%; text-align:right; word-spacing: 5px "> is a candidate
                                    of HSC Examination
                                    {{ $exam_year ?? '' }}.
                                </div>
                                <div style="clear:both;"></div>
                                <div>
                                    <div style="float:left; width:28%; text-align:left; word-spacing: 5px ">
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<html><head><title> Testimonial Said Exam College </title>');
