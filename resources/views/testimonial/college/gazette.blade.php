...
<body>
                ...
                <div class="panel panel-default">
                   ...
                   background-size: cover; background-position: center; background-repeat: no-repeat; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 350px; height: 350px; opacity: 0.08; z-index: 999999;">
                            ...
                            <div style="margin-bottom:20px;" class="reportDiv">
                                ...
                                <div style="float:left; width:51%; text-align:center; word-spacing: 5px ">passed the HSC
                                    Examination in
                                    {{ $exam_year ?? '' }}
                                    in
                                </div>
                                <div class="fbold"
                                    ...
                                    {{ $groupdata[$studentActivity->group_id] ?? '&nbsp;' }}
                                </div>
                                <div style="float:left; width:12%; text-align:right; word-spacing: 5px "> Group &</div>
                                <div style="clear:both;"></div>
                                <div>
                                    <div style="float:left; width:17%; text-align:left; word-spacing: 5px "> obtained
                                        GPA </div>
                                    <div class="fbold"
                                        style="float:left; width:12%; border-bottom:1px dashed #000000; text-align:center; ">
                                        {!! $gpa !== '' ? $gpa : '&nbsp;' !!} </div>
                                    <div style="float:left; width:45%;"> &nbsp; as per gazzette of BISE, Dhaka. </div>
                                    <div style="clear:both;"></div>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom:10px;" class="reportDiv">
                                {{ $student->gender == 1 ? 'He' : 'She' ?? '' }} bears a good moral character and to
                                the best of my knowledge, {{ $student->gender == 1 ? 'he' : 'she' ?? '' }} did not take
                                part in any activity subversive of the state or of discipline.
                            </div>
                            <div style="margin-bottom:80px;" class="reportDiv">
                                I wish {{ $student->gender == 1 ? 'his' : 'her' ?? '' }} success in life.
                            </div>
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<html><head><title> Testimonial Gazette Exam School </title>');
