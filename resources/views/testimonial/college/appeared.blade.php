...
<body>
                   ...
                   background-size: cover; background-position: center; background-repeat: no-repeat; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 350px; height: 350px; opacity: 0.08; z-index: 999999;">
                            ...
                            <div style="margin-bottom:20px;" class="reportDiv">
                                ...
                                <div class="fbold"
                                    ...
                                    {{ $groupdata[$studentActivity->group_id] ?? '_' }}
                                </div>
                                ...
                                <div style="clear:both;"></div>
                                <div>
                                    <div style="float:left; width:35%; text-align:left; word-spacing: 5px ">
                                        {{ $student->gender == 1 ? 'He' : 'She' ?? '' }} has appeared the exam.</div>
                                </div>
                                <div style="clear:both;"></div>
                            </div>
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<html><head><title> Testimonial Appeared Exam College </title>');
