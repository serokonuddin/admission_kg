...
<body>
                ...
                <div class="panel panel-default">
                   ...
                   background-size: cover; background-position: center; background-repeat: no-repeat; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 350px; height: 350px; opacity: 0.08; z-index: 999999;">
                            ...
                            <div style="margin-bottom:20px;" class="reportDiv">
                                ...
                                <div>
                                    <div style="float:left; width:60%; word-spacing: 5px"> is a Student of this college
                                        and passed in class </div>
                                    <div class="fbold"
                                        style="float:left; width:10%; border-bottom:1px dashed #000000; text-align:center; ">
                                        {{ isset($class_number) && array_key_exists($class_number, $classes) ? $classes[$class_number] : '' }}

                                    </div>
                                    <div style="float:left; width:5%; text-align: center">in</div>
                                    <div class="fbold"
                                ...
                                <div>
                                    <div style="float:left; width:3%; text-align: left">in</div>
                                </div>
                                <div class="fbold"
                                    style="float:left; width:15%; border-bottom:1px dashed #000000; text-align:center; ">
                                    {{ $session ?? '_' }}</div>
                                <div style="float:left; width:1%; text-align:left;">.</div>
                                <div style="float:left; width:25%; text-align:center; word-spacing: 5px">
                                    {{ $student->gender == 1 ? 'His' : 'Her' ?? '' }} Student ID is</div>
                                <div class="fbold"
                                    style="float:left; width:15%; border-bottom:1px dashed #000000; text-align:center; ">
                                    {{ $studentActivity->student_code ?? '' }}
                                </div>
                                <div style="float:left; width:1%; text-align:left;">.</div>
                                <div style="clear:both;"></div>
                            </div>
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<html><head><title> Testimonial Passed Exam College </title>');
