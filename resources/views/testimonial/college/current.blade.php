...
<body>
                ...
                <div class="panel panel-default">
                   ...
                   background-size: cover; background-position: center; background-repeat: no-repeat; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 350px; height: 350px; opacity: 0.08; z-index: 999999;">
                            ...
                            <div style="margin-bottom:20px;" class="reportDiv">
                                ...
                                <div>
                                    <div style="float:left; width:75%; word-spacing: 5px"> is a Student of this college
                                        and presently
                                        reading in class </div>
                                    <div class="fbold"
                                    ...
                                    <div style="float:right; width:5%; text-align: right">in</div>
                                    <div style="clear:both;"></div>
                                </div>

                                <div>
                                    <div class="fbold"
                                        style="float:left; width:30%; border-bottom:1px dashed #000000; text-align:center; ">
                                        {{ $studentActivity->section->section_name ?? '' }}</div>
                                </div>
                                <div style="float:left; width:23%; text-align:center; word-spacing: 5px ">Section of
                                </div>
                                <div class="fbold"
                                    style="float:left; width:22%; border-bottom:1px dashed #000000; text-align:center; ">
                                    {{ $studentActivity->version_id == 1 ? 'Bangla' : 'English' }}</div>
                                <div style="float:left; width:25%; text-align:right; word-spacing: 5px "> Version in
                                    Group:</div>
                                <div style="clear:both;"></div>
                                <div>
                                    <div class="fbold"
                                        style="float:left; width:25%; border-bottom:1px dashed #000000; text-align:center; ">
                                        {{ $groupdata[$studentActivity->group_id] ?? '_' }}</div>
                                    <div style="float:left; width:1%;"> . </div>
                                    <div style="float:left; width:25%; text-align:center; word-spacing: 5px ">
                                        {{ $student->gender == 1 ? 'His' : 'Her' }}
                                        Roll No.
                                        is</div>
                                    <div class="fbold"
                                        style="float:left; width:10%; border-bottom:1px dashed #000000; text-align:center; ">
                                        {{ $studentActivity->roll ?? '' }} </div>
                                    <div style="float:left; width:20%; text-align:center; word-spacing: 5px "> & Student
                                        ID: </div>
                                    <div class="fbold"
                            ...
                            <div style="margin-bottom:80px; word-spacing: 5px " class="reportDiv">
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<html><head><title> Testimonial Current College </title>');
