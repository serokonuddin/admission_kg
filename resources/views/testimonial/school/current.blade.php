...
<body>
                ...
                <div class="panel panel-default">
                   ...
                   background-size: cover; background-position: center; background-repeat: no-repeat; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 350px; height: 350px; opacity: 0.08; z-index: 999999;">
                            ...
                            <div style="margin-bottom:20px;" class="reportDiv">
                                ...
                                <div style="float:left; width:20%; text-align:center; word-spacing: 5px ">Section of
                                </div>
                                <div class="fbold"
                                ...
                                <div style="float:left; width:32%; text-align:right; word-spacing: 5px "> Version.
                                ...
                                <div>
                                    ...
                                    @if ($student->birthdate)
                                        <div style="float:left; width:30%; text-align:center; word-spacing: 5px ">
                                            {{ $student->gender == 1 ? 'His' : 'Her' }}
                                            Date of Birth is
                                        </div>
                                        <div class="fbold"
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<html><head><title> Testimonial Current School </title>');
