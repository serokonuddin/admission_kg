...
<body>
                   ...
                   background-size: cover; background-position: center; background-repeat: no-repeat; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 350px; height: 350px; opacity: 0.08; z-index: 999999;">
                            ...
                            <div style="margin-bottom:20px;" class="reportDiv">
                                ...
                                <div>
                                    ...
                                    <div style="float:left; width:10%; text-align: center">Section</div>
                                    <div class="fbold"
                                        style="float:left; width:25%; border-bottom:1px dashed #000000; text-align:center; ">
                                        {{ $studentActivity->section->section_name ?? '_' }}
                                    </div>
                                    <div style="float:left; width:10%; text-align: right">Version:</div>
                                    <div class="fbold"
                                ...
                                <div>
                                    <div style="float:left; width:18%; text-align:left; word-spacing: 5px ">& Student
                                        ID:</div>
                                </div>
                                <div class="fbold"
                                    style="float:left; width:23%; border-bottom:1px dashed #000000; text-align:center; ">
                                    {{ $studentActivity->student_code ?? '' }}</div>
                                <div style="float:left; width:30%; text-align:center; word-spacing: 5px "> is a
                                    candidate
                                    of class</div>
                                <div class="fbold"
                                ...
                                <div style="float:left; width:18%; text-align:right; word-spacing: 5px ">Annual Exam
                                </div>
                                <div style="clear:both;"></div>
                                <div>
                                    <div class="fbold"
                                        style="float:left; width:10%; border-bottom:1px dashed #000000; text-align:center; ">
                                        {{ $studentActivity->session_id ?? '' }} </div>
                                    <div style="float:left; width:90%; text-align:left; word-spacing: 5px ">.
                                        {{ $student->gender == 1 ? 'He' : 'She' ?? '' }} may appears in the said exam
                                        and hopefully pass.</div>
                                    <div style="clear:both;"></div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<html><head><title> Testimonial Cadet School </title>');
