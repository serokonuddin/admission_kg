       ...
       <div class="row mb-4">
          ...
          <div class="col-md-12">
             <div class="card">
                ...
                <div class="card-body">
                   <form class="needs-validation" method="post" action="{{ route('subject.store') }}"  novalidate="" id="formsubmit">
                    @csrf
                    ...
                    <table class="table">
                      ...
                      <tbody class="table-border-bottom-0">
                        ...
                        <tr id="row{{ $subject->id }}">
                          ...
                          <td style="word-wrap: break-word!important;">{{ $subject->subject_name }}</td>
                          <td style="word-wrap: break-word!important">{{ $subject->subject_name_bn }}</td>
                            <td style="word-wrap: break-word!important"></td>
                          <td style="word-wrap: break-word!important">{{ $subject->parent_subject }}</td>

                          <td>
                            @if ($subject->active == 1)
                            Active
                            @elseif($subject->active == 0)
                            Inactive
                            @endif
                          </td>
                            @if (Auth::user()->is_view_user == 0)
                            <td>
                                <div class="dropdown">
                                     ...
                                     <div class="dropdown-menu" style="">
                                         ...
                                         <a class="dropdown-item delete" data-url="{{ route('subject.destroy', $subject->id) }}" data-id="{{ $subject->id }}"  href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Delete</a>
                                     </div>
                                 </div>
                               </td>
                            @endif
