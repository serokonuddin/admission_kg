...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4">
          <span class="text-muted fw-light">Dashboard /</span> Designation
       </h4>
       <div class="row mb-4">
          <!-- Browser Default -->
                            ...
                            <td>
                                <div class="dropdown">
                                     ...
                                     <div class="dropdown-menu" style="">
                                         ...
                                         data-details="{{ $designation->details }}"
                                         data-serial="{{ $designation->serial }}"
                                         data-active="{{ $designation->active }}"
                                         href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                         <a class="dropdown-item delete" data-url="{{ route('designation.destroy', $designation->id) }}" data-id="{{ $designation->id }}"  href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Delete</a>
                                     </div>
                                 </div>
                               </td>
                            @endif
          ...
          <div class="col-md">
    <div class="card">
        <h5 class="card-header">Designation Entry</h5>
        <div class="card-body">
            <form class="needs-validation" method="post" action="{{ route('designation.store') }}" novalidate=""
                ...
                <div class="mb-3">
                    <label class="form-label" for="bs-name">Designation Name</label>
                ...
                <div class="mb-3">
                    <label class="form-label" for="bs-Address">Serial</label>
                    <input type="text" class="form-control" name="serial" id="serial" placeholder="Details"
                        required="">
                    <div class="valid-feedback"> Looks good! </div>
