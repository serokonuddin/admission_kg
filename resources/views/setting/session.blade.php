...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4">
          <span class="text-muted fw-light">Dashboard /</span> Session
       </h4>
       <div class="row mb-4">
          <!-- Browser Default -->
                            ...
                            <td>
                                <div class="dropdown">
                                     ...
                                     <div class="dropdown-menu" style="">
                                         ...
                                         <a class="dropdown-item delete" data-url="{{ route('session.destroy', $session->id) }}" data-id="{{ $session->id }}"  href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Delete</a>
                                     </div>
                                 </div>
                               </td>
                            @endif
          ...
          <div class="col-md">
    <div class="card">
        <h5 class="card-header">Session Entry</h5>
        <div class="card-body">
            <form class="needs-validation" method="post" action="{{ route('session.store') }}" novalidate=""
                ...
                <div class="mb-3">
                    <label class="form-label" for="bs-validation-name">Session Name</label>
                ...
                <div class="mb-3">
                    <label class="form-label" for="bs-validation-name">Session Code</label>
                    <input type="text" class="form-control" name="session_code" id="session_code"
                        placeholder="Session Code" required="">
                    <div class="valid-feedback"> Looks good! </div>
