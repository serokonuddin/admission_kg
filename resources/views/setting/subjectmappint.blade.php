            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" method="post" action="{{ route('subjectmapping.store') }}"
                                    ...
                                    @foreach ($classWiseSubject as $key => $subject)
                                        <tr id="row{{ $subject->id }}">
                                            ...
                                            <td style="word-wrap: break-word!important">
                                                {{ $subject->subject->subject_name ?? '' }}</td>
                                            <td style="word-wrap: break-word!important">
                                                {{ $subject->group->group_name ?? '' }}</td>
                                            <td style="word-wrap: break-word!important">Class
                                                {{ $words[$subject->class_code] ?? '' }}</td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            <a class="dropdown-item edit" data-id="{{ $subject->id }}"
