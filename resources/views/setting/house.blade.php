                          ...
                          <td>
                            <div class="dropdown">
                                 ...
                                 <div class="dropdown-menu" style="">
                                     ...
                                     <a class="dropdown-item delete" data-url="{{ route('house.destroy', $house->id) }}" data-id="{{ $house->id }}"  href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Delete</a>
                                 </div>
                             </div>
                           </td>
                          @endif
