...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4">
          <span class="text-muted fw-light">Dashboard /</span> Version
       </h4>
       <div class="row mb-4">
          <!-- Browser Default -->
          <div class="col-md mb-4 mb-md-0">
             <div class="card">
                <h5 class="card-header">Version List</h5>
                            ...
                            <td>
                                <div class="dropdown">
                                     ...
                                     <div class="dropdown-menu" style="">
                                         ...
                                         <a class="dropdown-item delete" data-url="{{ route('version.destroy', $version->id) }}" data-id="{{ $version->id }}"  href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Delete</a>
                                     </div>
                                 </div>
                               </td>
                            @endif
          ...
          <div class="col-md">
    <div class="card">
        <h5 class="card-header">Version Entry</h5>
        <div class="card-body">
            <form class="needs-validation" method="post" action="{{ route('version.store') }}" novalidate=""
                ...
                <div class="mb-3">
                    <label class="form-label" for="bs-validation-name">Version Name</label>
                ...
                <div class="mb-3">
                    <label class="form-label" for="bs-validation-name">Version Code</label>
                    <input type="text" class="form-control" name="version_code" id="version_code"
                        placeholder="Version Code" required="">
                    <div class="valid-feedback"> Looks good! </div>
