...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4">
          <span class="text-muted fw-light">Dashboard /</span> Discipline
       </h4>
       <div class="row mb-4">
          <!-- Browser Default -->
          <div class="col-md mb-4 mb-md-0">
             <div class="card">
                <h5 class="card-header">Discipline List</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table">
                      ...
                      <tbody class="table-border-bottom-0">
                        ...
                        <tr id="row{{ $discipline->id }}">
                          <th scope="row">{{ $key + 1 }}</th>
                          <td>{{ $discipline->name }}</td>
                          <td>{{ $discipline->degree->degree_name ?? '' }}</td>
                          <td>
                            @if ($discipline->active == 1)
                            Active
                            @elseif($discipline->active == 0)
                            Inactive
                            @endif
                          </td>
                            @if (Auth::user()->is_view_user == 0)
                            <td>
                                <div class="dropdown">
                                     ...
                                     <div class="dropdown-menu" style="">
                                         ...
                                         data-degree_id="{{ $discipline->degree_id }}"
                                         href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                         <a class="dropdown-item delete" data-url="{{ route('section.destroy', $discipline->id) }}" data-id="{{ $discipline->id }}"  href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Delete</a>
                                     </div>
                                 </div>
                               </td>
                            @endif
          ...
          <div class="col-md">
    <div class="card">
        <h5 class="card-header">Discipline Entry</h5>
        <div class="card-body">
            <form class="needs-validation" method="post" action="{{ route('discipline.store') }}" novalidate=""
                id="formsubmit">
                @csrf
                ...
                <div class="mb-3">
                    <label class="form-label" for="bs-Active">Degree</label>
                ...
                <div class="mb-3">
                    <label class="form-label" for="bs-validation-name">Discipline Name</label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="Discipline Name"
                        required="">
                    <div class="valid-feedback"> Looks good! </div>
                    <div class="invalid-feedback"> Please enter Discipline Name. </div>
                </div>
                <div class="mb-3">
