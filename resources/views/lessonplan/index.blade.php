        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                @if (Auth::user()->is_view_user == 0)
                    <div class="col-sm-12 col-md-12 card-header" style="text-align: right">
                        <a href="{{ route('lessonplan.create') }}" class=" btn btn-round btn-info">Create Lesson Plan</a>
                    </div>
                @endif
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="dataTables_length" id="DataTables_Table_0_length" style="padding: 5px">
                                <form id="form" method="get" action="{{ route('lessonplan.index') }}">
                    ...
                    <div class="table-responsive">
                        <table class="table pt-2" id="headerTable">
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                @foreach ($leasonplans as $key => $leasonplan)
                                    <tr id="row{{ $leasonplan->id }}">
                                        <td scope="row">{{ $key + 1 }}</td>
                                        <td>{{ $leasonplan->session->session_name ?? '' }}</td>
                                        <td>{{ $leasonplan->version->version_name ?? '' }}</td>
                                        <td>{{ $leasonplan->classes->class_name ?? '' }}</td>
                                        <td>{{ $leasonplan->subject->subject_name ?? '' }}</td>
                                        <td>{{ $leasonplan->employee->employee_name ?? '' }}</td>
                                        <td>{{ $leasonplan->date ?? '' }}</td>
                                        <td>{{ $leasonplan->time ?? '' }}</td>
                                        <td>
                                            @if ($leasonplan->pdf)
                                                <a href="{{ $leasonplan->pdf }}" target="_blank"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="">
                                                        <a class="dropdown-item edit"
                                                            href="{{ route('lessonplan.edit', $leasonplan->id) }}"><i
                                                                class="bx bx-edit-alt me-1"></i> Edit</a>
                                                        <a class="dropdown-item delete"
                                                            data-url="{{ route('lessonplan.destroy', $leasonplan->id) }}"
                                                            data-id="{{ $leasonplan->id }}" href="javascript:void(0);"><i
    ...
    <script notice="text/javascript">
        $(document).ready(function() {
            ...
            $(document.body).on('click', '.delete', function() {
                ...
                Swal.fire({
                    title: 'Do you want to delete this Lesson Plan?',
                    showDenyButton: true,
