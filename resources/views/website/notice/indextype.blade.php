    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       ...
       <div class="row mb-4">
          ...
          <div class="col-md mb-4 mb-md-0">
             <div class="card">
                <h5 class="card-header">Notice Type List</h5>
                            ...
                            <td>
                                <div class="dropdown">
                                     ...
                                     <div class="dropdown-menu" style="">
                                         ...
                                         <a class="dropdown-item delete" data-url="{{ route('notice-type.destroy', $type->id) }}" data-id="{{ $type->id }}"  href="javascript:void(0);"><i class="bx bx-trash me-1"></i> Delete</a>
                                     </div>
                                 </div>
                               </td>
                            @endif
          ...
          <div class="col-md">
    <div class="card">
        <h5 class="card-header">Notice Type Entry</h5>
        <div class="card-body">
            <form class="needs-validation" method="post" action="{{ route('notice-type.store') }}" novalidate=""
                id="formsubmit">
                @csrf
                <input type="hidden" name="id" id="id" value="0" />
                <div class="mb-3">
                    <label class="form-label" for="bs-validation-name">Notice Type Name</label>
