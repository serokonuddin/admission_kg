            ...
            <div class="col-md mb-4 mb-md-0">
                <div class="card shadow-sm">
                    <div class="card-body">
                            ...
                            <strong>Date:&nbsp;
                               {{ $headerData['from_date'] . ' ' . '-' . ' ' . $headerData['to_date'] }}</strong>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center justify-content-center">
                                        <p class="average-mark mb-0">
                                            <span class="text-muted">Attendance percentange:</span>
                                            <strong>{{ number_format($sectionAttendance[$section->id], 2) }}%</strong>
                                        </p>
                                    </div>
                                </div>
                            </div>
