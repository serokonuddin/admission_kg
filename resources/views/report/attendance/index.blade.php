        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <input type="hidden" id="allowedStartDate" value="{{ $allowedStartDate }}">
                        <input type="hidden" id="allowedEndDate" value="{{ $allowedEndDate }}">
                        <div class="col-sm-12 col-md-12">
                            <div class="row g-3 searchby">
                                ...
                                <div class="col-sm-4">
                                    <label for="student_code" class="form-label">Student <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="col-sm-12">
                                <div class="d-flex justify-content-end mt-2">
                                    <a href="{{ route('attendance.pdf') }}" class="btn btn-primary btn-sm"
                                        target="_blank">
                                        Download PDF
                                    </a>
                                </div>
        ...
        $(document).ready(function() {
            ...
            $(document.body).on('click', '#search', function() {
                ...
                if (section_id && start_date && end_date && version_id && shift_id && session_id &&
                    ...
                    var url = "{{ route('attendance.getReport') }}";
                    $.LoadingOverlay("show");
                    $.ajax({
                        type: "get",
                        headers: {
