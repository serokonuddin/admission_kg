...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y" id="attendance-part">
            {{-- <h4 class="py-3 mb-4"><span class="text-muted fw-light">Attendance /</span> Student Attendance</h4> --}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="needs-validation" method="post" action="{{ route('studentAttendanceStore') }}"
                        ...
                        <div class="card mb-4">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="form-check form-check-inline mt-3">
                                            <input class="form-check-input" type="radio" checked="checked"
                                                name="version_id"
                                                {{ Session::get('version_id') == 1 ? 'checked="checked"' : '' }}
                                                id="bangla" value="1">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="version_id" id="english"
                                                {{ Session::get('version_id') == 2 ? 'checked="checked"' : '' }}
                                                value="2">
                                        ...
                                        <div class="form-check form-check-inline mt-3">
                                            <input class="form-check-input" type="radio" checked="checked" name="shift_id"
                                                id="Morning"
                                                {{ Session::get('shift_id') == 1 ? 'checked="checked"' : '' }}
                                                value="1">
                                            <label class="form-check-label" for="Morning">Morning</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="shift_id" id="Day"
                                                {{ Session::get('shift_id') == 2 ? 'checked="checked"' : '' }}
                                                value="2">
                           ...
                           <select id="shift_id" class=" form-select">
                              ...
                              @endforeach
                                            ...
                                            <select id="class_id" name="class_id" class=" form-select" required>
                                                ...
                                                @foreach ($classess as $key => $class)
                                                    <option value="{{ $class->class_code }}"
                                                        {{ Session::get('class_id') == $class->class_code ? 'selected="selected"' : '' }}>
                                            ...
                                            <select id="section_id" name="section_id" class=" form-select">
                                                ...
                                                @foreach ($sections as $key => $section)
                                                    <option value="{{ $section->id }}"
                                                        {{ Session::get('section_id') == $section->id ? 'selected="selected"' : '' }}>
                                        ...
                                        <div class="mb-2 col-md-3">
                                            <label class="form-label" for="section">Status</label>
        ...
        $(function() {
            ...
            $(document.body).on('change', '#section_id', function() {
                ...
                if (section_id && attendance_date && version_id && shift_id && session_id && class_id) {
                    var url = "{{ route('getStudentsReport') }}";
                    $.ajax({
                        type: "get",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')
