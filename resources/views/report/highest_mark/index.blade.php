...
@section('content')
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <nav aria-label="breadcrumb" class="my-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> Highest Mark Report </li>
    ...
    <script>
        ...
        $(document.body).on('click', '.version-btn', function() {
            ...
            if (version_id) {
                var url = "{{ route('highest.getShiftsForVersion') }}";
                $.LoadingOverlay("show");
                $.ajax({
                    type: "POST",
                    headers: {
        ...
        $(document.body).on('click', '[name="shiftId"]', function() {
            ...
            if (shiftId && version_id && class_code) {
                ...
                var url = "{{ route('highest_all_sections_page') }}";
                $.LoadingOverlay("show");
                $.ajax({
                    type: "POST",
                    headers: {
        ...
        // Handle version wise shift change
    </script>
@endsection
