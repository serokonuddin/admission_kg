<div class="" id="ReportBox">
            ...
            <div class="panel-heading">
                <div class="pull-right">
                    <input type="button" class="btn btn-success btn-panel-head"
                        onclick="printElem('studenttAcademicTranscriptDiv')" value="Print">
                </div>
            </div>
            <div class="panel-body">
                <div id="studenttAcademicTranscriptDiv">
                    <style>
                        .tableBorderNo {
                        ...
                        <table cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; text-align: center;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width: 70%; text-align: center; padding: 0 20px;">
                                                        <h1
                                                            style="margin: 0; font-size: 24px; color: #0484BD; font-weight: bold;">
                                                        ...
                                                        <h2
                                                            style="margin: 8px 0; font-size: 18px; color: #D9534F; font-weight: 700;">
                                                            Academic Transcript
                                                        </h2>
                                                    </td>
                                    ...
                                    {{-- <td
                                        style="width: 25%; vertical-align: top; padding: 15px; border-left: 1px solid #ddd;">
                                        <table cellpadding="0" cellspacing="0"
                                            style="width: 100%; border: 1px solid #ddd; text-align: center; font-size: 12px; border-collapse: collapse;">
                                            <thead style="background-color: #f9f9f9;">
                                                <tr>
                                                    <th
                                                        style="border: 1px solid #ddd; padding: 6px; font-weight: bold;">
                                                        Marks Range</th>
                                                    <th
                                                        style="border: 1px solid #ddd; padding: 6px; font-weight: bold;">
                                                        LG</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">80-100</td>
                                                    <td
                                                        style="border: 1px solid #ddd; padding: 6px; font-weight: bold; color: #3c763d;">
                                                        A+</td>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">5.00</td>
                                                </tr>
                                                <tr>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">70-79</td>
                                                    <td
                                                        style="border: 1px solid #ddd; padding: 6px; font-weight: bold; color: #3c763d;">
                                                        A</td>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">4.00</td>
                                                </tr>
                                                <tr>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">60-69</td>
                                                    <td
                                                        style="border: 1px solid #ddd; padding: 6px; font-weight: bold; color: #f0ad4e;">
                                                        A-</td>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">3.00</td>
                                                </tr>
                                                <tr>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">50-59</td>
                                                    <td
                                                        style="border: 1px solid #ddd; padding: 6px; font-weight: bold; color: #f0ad4e;">
                                                        B</td>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">2.00</td>
                                                </tr>
                                                <tr>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">0-49</td>
                                                    <td
                                                        style="border: 1px solid #ddd; padding: 6px; font-weight: bold; color: #d9534f;">
                                                        F</td>
                                                    <td style="border: 1px solid #ddd; padding: 6px;">0.00</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td> --}}
                            ...
                            <table class="resultDetailsTable" width="100%" cellspacing="0" cellpadding="0"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($studentdata as $key1 => $studen)
                                        @php
                                            $subjectId = $studen->subject_id ?? null;
                                            $cqTotal = $studen->cq_total ?? null;
                                            $mcqTotal = $studen->mcq_total ?? null;
                                            $practicalTotal = $studen->practical_total ?? null;
                                            $isAbsent = $studen->is_absent ?? null;

                                            $isCqAbsent = $studen->is_cq_abs ?? 0;
                                            $isMcqAbsent = $studen->is_mcq_abs ?? 0;
                                            $isPracAbsent = $studen->is_prac_abs ?? 0;
                                            $isCtAbsent = $studen->is_ct_abs ?? 0;
                                            $isQuizAbsent = $studen->is_quiz_abs ?? 0;
                                            ...
                                            $highlightCq =
                                                ...
                                                ((in_array($subjectId, $specialSubjectsPrac) &&
                                                    $cqTotal !== null &&
                                                    ($cqTotal < 23 ||
                                                        (($subjectId == 71 || $subjectId == 72) && $cqTotal < 20))) ||
                                                    (!in_array($subjectId, $specialSubjectsPrac) &&
                                                        $cqTotal !== null &&
                                                        $cqTotal < 17));
                                                    ...
                                                    <td
                                                        ...
                                                        @else
                                                            ...
                                                            @if ($mcqTotal !== '-')
                                                                <br>
                                                                <button type="button"
                                                                    class="btn btn-xs btn-primary mt-1 noprint"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#mcqModal{{ $studen->subject_id }}">Check</button>
                                                            @endif
                                                        @endif

                                                        @php
                                                            $mcqAnswers = [
                                                                ['correctAnswer' => 'B', 'studentAnswer' => 'B'],
                                                                ['correctAnswer' => 'D', 'studentAnswer' => 'C'],
                                                                ['correctAnswer' => 'A', 'studentAnswer' => 'A'],
                                                                ['correctAnswer' => 'C', 'studentAnswer' => 'D'],
                                                                ['correctAnswer' => 'D', 'studentAnswer' => 'D'],
                                                                ['correctAnswer' => 'B', 'studentAnswer' => 'A'],
                                                                ['correctAnswer' => 'C', 'studentAnswer' => 'C'],
                                                                ['correctAnswer' => 'A', 'studentAnswer' => 'B'],
                                                                ['correctAnswer' => 'D', 'studentAnswer' => 'D'],
                                                                ['correctAnswer' => 'B', 'studentAnswer' => 'C'],
                                                                ['correctAnswer' => 'B', 'studentAnswer' => 'C'],
                                                                ['correctAnswer' => 'B', 'studentAnswer' => 'C'],
                                                                ['correctAnswer' => 'B', 'studentAnswer' => 'C'],
                                                                ['correctAnswer' => 'B', 'studentAnswer' => 'C'],
                                                            ...
                                                            $totalQuestions = count($mcqAnswers);
                                                            $totalCorrect = count(
                                                                array_filter(
                                                                    $mcqAnswers,
                                                                    fn($answer) => $answer['correctAnswer'] ==
                                                        ...
                                                        @if ($mcqTotal !== '-')
                                                            <!-- Modal -->
                                                            <div class="modal fade noprint"
                                                                id="mcqModal{{ $studen->subject_id }}" tabindex="-1"
                                                                aria-labelledby="mcqModalLabel{{ $studen->subject_id }}"
                                                                aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="mcqModalLabel{{ $studen->subject_id }}">
                                                                                MCQ Answers for
                                                                                {{ $subjects[$studen->subject_id][0]->short_name ?? '' }}
                                                                            </h5>
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<style>@page { size: 210mm 297mm; margin: 45mm 5mm 5mm 5mm; }</style>');
