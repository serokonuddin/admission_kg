                            ...
                            <div style="">
                                <table class="resultDetailsTable">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Version: {{ $activity->version->version_name ?? '' }}</td>
                                            <td>Class : {{ $activity->class_code }}</td>
                                            <td>Section: {{ $activity->section->section_name ?? '' }}</td>
                                ...
                                <tbody>
                                            ...
                                            @php
                                                ...
                                                foreach ($subjects as $key1 => $subject) {
                                                    if (
                                                        ...
                                                        $gpa_point += $subjectwisemark[$subject[0]->id][0]->gpa_point;
                                                    }
                                                    if (isset($subjectwisemark[$subject[0]->id][0]->ct_conv_total)) {
                                                        $total += $subjectwisemark[$subject[0]->id][0]->ct_conv_total;
                                                    }
                                                }
                                                $point = '';
                                                if ($gpa_point == -1) {
                                    ...
                                    @if ($class_code == 4)
                                        ...
                                        <tr>
                                            <td>Conv to 80%</td>
                                            @foreach ($subjects as $key1 => $subject)
                                                <td>{{ $subjectwisemark[$subject[0]->id][0]->conv_total ?? '' }}</td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td>Grand</td>
                                            @foreach ($subjects as $key1 => $subject)
                                                <td>{{ $subjectwisemark[$subject[0]->id][0]->ct_conv_total ?? '' }}</td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td>Grade</td>
                                        ...
                                        <tr>
                                            <td>Grade Point</td>
                                            @foreach ($subjects as $key1 => $subject)
                                                <td>{{ $subjectwisemark[$subject[0]->id][0]->gpa_point ?? '' }}</td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td>Highest Marks</td>
                                    ...
                                    @if ($class_code == 4)
                                        ...
                                        <tr>
                                            <td>Grand</td>
                                            @foreach ($subjects as $key1 => $subject)
                                                <td>{{ $avaragemark[$subject[0]->id][0]->ct_conv_total ?? '' }}</td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td>Grade</td>
                        ...
                        <div style="padding-top:10px; padding-bottom:5px">
                            ...
                            <table class="resultDetailsTable" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td rowspan="5" style="text-align:center;width: 30%!important">Vice Principal
                                    </td>
