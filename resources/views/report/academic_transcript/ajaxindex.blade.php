                ...
                <div id="StudentAcademicTranscriptDiv">
                    ...
                    <div class="printHead" style="font-family:'Times New Roman, Times, serif';  margin-top:5px;">
                                ...
                                <table class="noBorder">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Class</td>
                                            <td> :
                                                {{ $classroman[$activity->class_code] ?? '' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Father's Name</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:10%; color:blue; font-weight:bold;">
                                                &nbsp;</td>
                                            <td style="width:13%; color:blue; font-weight:bold;">
                                                &nbsp; </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>Session</td>
                                            <td><span>:</span>
                                                {{ $activity->session->session_name ?? '' }}-{{ (int) $activity->session->session_name + 1 }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                        ...
                        <table
                            ...
                            <tbody>
                                <tr>
                                    <td style="border:2px solid black; padding-left:7px; padding-right:7px;">
                        ...
                        @php
                            ...
                            $subjects = collect($student->subjectmark)->groupBy(['subject_id', 'marks_for']);

                            $fourthSubjects = collect($student->subjectmark)->filter(function ($subjectmark) {
                                ...
                                <tbody>
                                    <tr style="font-weight:bold;">
                                        ...
                                        <td rowspan="2" style="text-align:center;">Subject
                                            Name</td>
                                        <td colspan="{{ $markforcount }}" style="text-align:center;">Marks Obtained
                                        </td>
                                            ...
                                            @foreach ($subjectsmapping as $key => $subj)
                                                @if (isset($subject[$subj][0]->total_mark))
                                                    <td style="text-align:center;" class="">
                                                        ...
                                                        @php
                                                            if ($subject[$subj][0]->is_fourth_subject) {
                                                                $is_fourth_subject = 1;
                                                            }
                                                            $total_mark += (int) $subject[$subj][0]->total_mark;
                                                        @endphp
                                                    </td>
                                                @else
                                                    <td>
                            ...
                            <table class="resultDetailsTable" cellpadding="0" cellspacing="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center; font-weight:bold;border-left:none; ">
                                            494</td>
                                    </tr>
                                    <tr>
                                        <td style="border-right:none;">Position in Section</td>
                                        <td style="border-left:none; border-right:none;">:</td>
                                        <td style="border-left:none; text-align:center; font-weight:bold;">
                                            <span>4</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;font-weight:bold;" nowrap="">Principal /
                                            Vice-Principal</td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="noBorder" width="100%" style="margin-top:18px;">
                                <tbody>
                                    <tr style="border:1px thin black;">
                                        <td style="float:left; font-size:12px; font-weight:bold;">
                                            Result Published Date : </td>
                                        <td style="float:right; font-size:12px; font-weight:bold; color: gray;">
                                            Developed by : </td>
                                    </tr>
                                </tbody>
                            </table>
