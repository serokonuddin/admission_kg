...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y" id="attendance-part">
            ...
            <div class="row">
                <div class="col-md-12">
                    @if (Auth::user()->getMenu('staffAttendanceStore', 'name'))
                        <form class="needs-validation" method="post" action="{{ route('staffAttendanceStore') }}"
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="form-check form-check-inline mt-3">
                                        <input class="form-check-input" type="radio" checked="checked" name="shift_id"
                                            id="Morning" {{ Session::get('shift_id_s') == 1 ? 'checked="checked"' : '' }}
                                            value="1">
                                        <label class="form-check-label" for="Morning">Morning</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="shift_id" id="Day"
                                            {{ Session::get('shift_id_s') == 2 ? 'checked="checked"' : '' }}
                                            value="2">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="text"
                                            ...
                                            value="{{ Session::get('attendance_date_s') ? Session::get('attendance_date_t') : date('Y-m-d') }}"
