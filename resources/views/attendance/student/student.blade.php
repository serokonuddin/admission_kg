...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y" id="attendance-part">
            ...
            <div class="row">
                <div class="col-md-12">
                    @if (Auth::user()->getMenu('studentAttendanceStore', 'name'))
                    ...
                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                        <li class="nav-item type college" data-type="college">
                            <a class="nav-link {{ $type == 3 || $type == '' ? 'active' : '' }}"
                                href="javascript:void(0);"><img src="{{ asset('public/image/college.png') }}"> College</a>
                        </li>
                            ...
                            <div class="row gy-3">
                                <div class="col-md">
                                    <div class="form-check form-check-inline mt-3">
                                        <input class="form-check-input" type="radio" checked="checked" name="version_id"
                                            {{ Session::get('version_id') == 1 ? 'checked="checked"' : '' }} id="bangla"
                                            value="1">
                                    ...
                                    <div class="form-check form-check-inline mt-3">
                                        <input class="form-check-input" type="radio" checked="checked" name="shift_id"
                                            id="Morning" {{ Session::get('shift_id') == 1 ? 'checked="checked"' : '' }}
                                            value="1">
                                        <label class="form-check-label" for="Morning">Morning</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="shift_id" id="Day"
                                            {{ Session::get('shift_id') == 2 ? 'checked="checked"' : '' }} value="2">
