...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span>Admission Selection List</h4>
            <div class="card">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="dataTables_length" id="DataTables_Table_0_length" style="padding: 5px">

                            <form action="{{ route('kgAdmitListselection') }}" method="GET">
                            ...
                            <form action="{{ route('kgAdmitListselectionUpload') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row g-3 searchby">
                                    <div class="col-sm-3">
                                        <label for="formFile" class="form-label">Default file input example (Allowed
                                            formats: XLSX, XLS, CSV. Max file size: 200 KB)</label>
                                        <input class="form-control" type="file" name="selection_file" id="formFile"
                                            accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                                        <input class="form-control" type="hidden" name="file_old" id="formFile1"
                                            value="">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="mt-4">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @foreach ($students as $key => $student)
                                <tr>
                                    ...
                                    <td>{{ $student->status == 2 ? 'Admitted' : 'Not Admitted' }}</td>
                                    <td>
                                        <button class="btn btn-primary btn-sm"
                                            onclick="sendSMS('{{ $student->id }}')">SMS</button>
                                        <button class="btn btn-secondary btn-sm kgadmission"
                                            data-id="{{ $student->id }}" data-session_id="{{ $student->session_id }}"
