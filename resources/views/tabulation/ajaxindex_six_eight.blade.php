                                ...
                                <table class="resultDetailsTable" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="font-weight:bold;">
                                            ...
                                            <td style="text-align:center;">CT + PT</td>
                                            ...
                                            <td style="text-align:center;">Grade Letter</td>
                                        ...
                                        @foreach ($studentdata as $key1 => $studen)
                                            @php
                                                ...
                                                $term_marks1 = $term_marks->firstWhere('id', 107)?->subjectMarkTerms;
                                            ...
                                            @if (
                                                ...
                                                <tr>
                                                    ...
                                                    @foreach ($subjectsmapping as $key => $subject)
                                                        ...
                                                        @elseif($subject == 1)
                                                            <td style="text-align:center;">
                                                                {{ isset($studen->cq) && $studen->cq > 0 ? $studen->cq : '' }}

                                                            </td>
                                                        @elseif($subject == 2)
                                                            <td style="text-align:center;">
                                                                {{ isset($studen->mcq) && $studen->mcq > 0 ? $studen->mcq : '' }}
                                                            </td>
                                                        @else
                                                            <td style="text-align:center;">
                                        ...
                                        @php
                                            if ($gpa_point == -1) {
                                                ...
                                                $point = round($gpa_point / (count($studentdata) - 2), 2);
                                            }
                                        @endphp
                                        <tr>
                                            <td style="text-align:left;" colspan="7">Grand Total Marks, Grade
                                                Letter,
                                                GPA</td>
                                            <td style="text-align:center;">{{ $total ?? '' }}</td>
                                            @php
                                                ...
                                                $failStyle =
                                                    $grade === 'F' ? 'color:red; text-decoration:underline;' : '';
                                            @endphp

                                            <td style="text-align:center; {{ $failStyle }}">
                                                {{ $grade }}
                                            </td>
                                            <td style="text-align:center;">{{ $averageGPA }}
                                            </td>
                                            <td style="text-align:center;"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left;" colspan="7">Percentage of Total Marks
                                            </td>
                                            <td style="text-align:center;">
                                                @php
                                                $percentage = round(($total * 100) / (count($studentdata) * 100 - 100));
                                            @endphp
                                                {{ $percentage }}%
                                            </td>
                                            <td style="text-align:center;"></td>
