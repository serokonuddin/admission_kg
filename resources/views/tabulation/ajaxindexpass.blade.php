<div class="" id="ReportBox">
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            var footerContent = `
        <footer style="position: fixed; bottom: 0; width: 100%; text-align: left; font-size: 12px; border-top: 1px solid #ccc; padding: 10px 0;">
    ...
    `;
            ...
            mywindow.document.write('<html><head><title>Pass List</title>');
