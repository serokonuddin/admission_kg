...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            {{-- <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Dashboard /</span> Tabulation
            </h4> --}}
            <nav aria-label="breadcrumb" class="my-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> Tabulation</li>
                </ol>
            </nav>
                ...
                $(document.body).on('click', '#searchtop', function() {
                    ...
                    if (session_id && class_code && section_id && exam_id) {
                        ...
                        $.ajax({
                            ...
                            url: "{{ route('getTabulationSection') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                getdata,
                                session_id,
