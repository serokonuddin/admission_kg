                                        ...
                                        <td style="width:25%; vertical-align: top; padding-left: 10px;">
                                            <table cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="border: 1px solid #000; padding: 3px;">0-39</td>
                                ...
                                <table class="resultDetailsTable" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        <tr style="font-weight:bold;">
                                            ...
                                            <td colspan="{{ $markforcount + 8 }}" style="text-align:center;">
                                                {{ $exam->exam_title }}</td>
                                        ...
                                        <tr style="font-weight:bold;">
                                            ...
                                            <td colspan="" style="text-align:center;">Full Mars</td>
                                            ...
                                            <td style="text-align:center;">Conv to 80%</td>
                                            <td style="text-align:center;">Subject <br /> Total</td>
                                            <td style="text-align:center;">Grade <br /> Letter</td>
                                        ...
                                        @foreach ($studentdata as $key1 => $studen)
                                            @php
                                                ...
                                                $ispractical = $term_marks
                                                    ...
                                                    ->where('marks_for', 3)
                                                    ->first();
                                                $cqpassmark = $term_marks
                                                    ->flatten(3)
                                                    ->where('subject_id', $studen->subject_id)
                                                    ->where('marks_for', 1)
                                                    ->first()?->pass_mark;
                                                $mcqpassmark = $term_marks
                                                    ->flatten(3)
                                                    ->where('subject_id', $studen->subject_id)
                                                    ->where('marks_for', 2)
                                                    ->first()?->pass_mark;
                                                $practicalpassmark = $term_marks
                                                    ->flatten(3)
                                                    ->where('subject_id', $studen->subject_id)
                                                    ->where('marks_for', 3)
                                                    ->first()?->pass_mark;
                                                $totalpassmark = 40;
                                                if ($studen->subject_id == 9) {
                                                    $totalpassmark = 20;
                                                }
                                            @endphp
                                            @if (
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        {{ in_array($studen->subject_id, [9, 59, 62]) ? 50 : 100 }}
                                                    </td>
                                                    @foreach ($subjectsmapping as $key => $subject)
                                                        @if ($subject == 0)
                                                            <td style="text-align:center;">
                                                        ...
                                                        @elseif($subject == 1)
                                                            <td
                                                                style="text-align:center; {{ $cqpassmark > $studen?->cq_total && !in_array($studen->subject_id, [58, 59, 61, 62])
                                                        ...
                                                        @elseif($subject == 2)
                                                            <td
                                                                style="text-align:center; {{ $mcqpassmark > $studen?->mcq_total && !in_array($studen->subject_id, [58, 59, 61, 62]) ? 'color:red; text-decoration: underline' : '' }}">
                                            ...
                                            @elseif(
                                                ...
                                                <tr>
                                                    ...
                                                    @php
                                                        ...
                                                        $pair_total = $cq_total + $mcq_total + $practical_total;
                                                        $conv_total = round($pair_total * 0.8);
                                                        $pair_all_total = $ct + $conv_total;
                                                        $cq_pair_pass_mark = $pair_name == 'English' ? 60 : 42;
                                                        $mcq_pair_pass_mark = 18;
                                                        $pair_total_pass_mark = 60;
                                                    @endphp
                                                    @foreach ($subjectsmapping as $key => $subject)
                                                        @if ($subject == 0)
                                                            <td style="text-align:center;">
                                                        ...
                                                        @elseif($subject == 1)
                                                            <td
                                                                style="text-align:center; {{ $cq_pair_pass_mark > $cq_total && $class_code != 6 ? 'color:red; text-decoration: underline' : '' }}">
                                                        ...
                                                        @elseif($subject == 2)
                                                            <td
                                                                ...
                                                                {{ $mcq_pair_pass_mark > $mcq_total && $class_code != 6 ? 'color:red; text-decoration: underline' : '' }}">
                                                    ...
                                                    <td
                                                        style="text-align:center;
                                                        {{ $pair_total_pass_mark > $pair_total ? 'color:red; text-decoration: underline' : '' }}">
                                                        {{ $pair_total ?? '' }}
                                                    </td>
                                                    <td style="text-align:center;">
                                                        {{ $conv_total ?? '' }}
                                                    ...
                                                    <td
                                                        style="text-align:center;
                                                        {{ $pair_total_pass_mark > $pair_all_total ? 'color:red; text-decoration: underline' : '' }}">
                                                        {{ $pair_all_total ?? '' }}
                                                    </td>
                                                    <td style="text-align:center;"
                                            ...
                                            @else
                                                <tr>
                                                    ...
                                                    <td
                                                        style="text-align:center; {{ $totalpassmark > $studen?->total && !in_array($studen->subject_id, [58, 59, 61, 62]) ? 'color:red; text-decoration: underline' : '' }}">
                                                        {{ $studen->total ?? '' }}
                                                    </td>
                                                    <td style="text-align:center;">
                                                        {{ $studen->conv_total }}
                                        ...
                                        @endphp
                                        <tr style="font-weight:bold;">
                                            <td colspan="{{ 6 + $markforcount - 1 }}">
                                                Grand Total Marks, Grade Letter and Grade Point
                                            </td>
