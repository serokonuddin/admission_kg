                                ...
                                <tbody>
                                    ...
                                    @foreach ($students as $key => $student)
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">{{ $student->total_attendance }}</td>
                                            <td style="text-align:center;">
                                                
                                                {{ $student->total_mark }}
                                            </td>
                                            <td style="text-align:center;">
                                                {{ getGrade($student->grade_point, 1) }}
                                            </td>
                                            <td style="text-align:center;">
                                                {{ $student->grade_point }}
                                            </td>
                                            <td style="text-align:center;">{{ $student->next_section }}</td>
                                            <td style="text-align:center;">{{ $student->position_in_section }}</td>
                                            <td style="text-align:center;">{{ $student->position_in_class }}</td>
