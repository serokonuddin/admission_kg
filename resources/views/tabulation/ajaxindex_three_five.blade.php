                                ...
                                <table class="resultDetailsTable" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="font-weight:bold;">
                                            ...
                                            <td style="text-align:center;" colspan="3">Exam Type and Marks</td>
                                        ...
                                        <tr style="font-weight:bold;">
                                            <!-- <td rowspan="2" style="text-align:center;">Subject Type<br></td> -->
                                            <td style="text-align:center;">CA (CT + PT)</td>
                                            <td style="text-align:center;">Term Exam</td>
                                            <td style="text-align:center;">Convert to 80% of Term Exam</td>
                                        </tr>
                                        ...
                                        @foreach ($subjects as $key => $subject)
                                            @php
                                                ...
                                                $subjectMarks = $marks[$subject[0]->id][0] ?? null;
                                                $isFailed =
                                                    $subject[0]->id != 39 && ($subjectMarks->gpa_point ?? 0) == 0;
                                                if ($isFailed) {
                                                    $isFailedOnce = true;
                                                }
                                                ...
                                                if ($subject[0]->id != 39) {
                                                    ...
                                                    $totalmark += $subjectMarks->total ?? 0;
                                                    $totalgpa += $subjectMarks->gpa_point ?? 0;
                                                }
                                            @endphp
                                            <tr>
                                                ...
                                                @if ($subject[0]->id !== 39)
                                                    <td style="text-align:center;">{{ $subjectMarks->ct1 ?? '' }}</td>
                                                    <td style="text-align:center;">{{ $subjectMarks->cq ?? '' }}</td>
                                                    <td style="text-align:center;">
                                                        {{ $subjectMarks->conv_total ?? '' }}
                                                    </td>
                                                    <td
                                                ...
                                                <td
                                                    style="text-align:center; {{ $isFailed ? 'color:red; text-decoration:underline;' : '' }}">
                                                    {{ isset($subjectMarks->gpa_point) ? number_format($subjectMarks->gpa_point, 2) : '' }}
                                                </td>
                                                <td style="text-align:center;">
