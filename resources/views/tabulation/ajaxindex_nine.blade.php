<div class="" id="ReportBox">
                                    ...
                                    <tbody>
                                            ...
                                            @if (
                                                ...
                                                <tr>
                                                    ...
                                                    @foreach ($subjectsmapping as $key => $subject)
                                                        @php
                                                            $faildv =
                                                                $term_marks[$studen->subject_id][$subject][0]
                                                                    ->pass_mark ?? 0;
                                                            $term_text = '';
                                                        @endphp
                                                        @if ($subject == 0)
                                        ...
                                        <tr style="font-weight:bold;">
                                            <td colspan="{{ $markforcount + 5 }}">
                                                ...
                                                Grand Total Marks, Grade Letter and Grade Point without 4th subject
                                            </td>
                                        ...
                                        <tr style="font-weight:bold;">
                                            <td colspan="{{ $markforcount + 6 }}">
                                                Grade Letter and Grade Point with 4th subject
                                            </td>
                                            {{-- <td style="text-align:center;">{{ $total - $forth_subject_mark ?? '' }} --}}
                                            {{-- </td> --}}
                                            <td style="text-align:center;"
                                                class="{{ $isnegative == -1 ? 'redtext' : '' }}">
                                                {{ getGrade($with_four_point, $isnegative) }}
                                            </td>
                                            <td style="text-align:center;"
                                                class="{{ $isnegative == -1 ? 'redtext' : '' }}">
    ...
    <script type="text/javascript">
        function printElem(divId) {
            ...
            mywindow.document.write('<style>@page { size: A4; margin: 190px 5mm 5mm 5mm; }</style>');
