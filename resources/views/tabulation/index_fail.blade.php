...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            {{-- <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Dashboard /</span> Fail List
            </h4> --}}
            <nav aria-label="breadcrumb" class="my-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> Fail List</li>
                </ol>
            </nav>
        ...
        <script>
            $(function() {
                ...
                function downloadExcel() {
                    ...
                    if (APP_ENV === 'local') {
                        var downloadUrl = '/sms/admin/export-fail-list' + queryString;
                    } else if (APP_ENV === 'production') {
                        var downloadUrl = '/admin/export-fail-list' + queryString
                    }
