                            ...
                            <table class="resultDetailsTable" width="100%" cellspacing="0" cellpadding="0"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">CT-1</th>
                                        <th style="text-align: center;">CT-2</th>
                                ...
                                <tbody>
                                    @foreach ($students as $k => $student)
                                        ...
                                        @endphp
                                        @for ($key = 0; $key < ($version == 1 ? 3 : ($class == 0 ? 5 : 6)); $key++)
                                            @php
                                            ...
                                            @endphp
                                            @if ($key < ($version == 1 ? 1 : ($class == 0 ? 2 : 3)))
                                                <tr>
                                                    @if ($key == 0)
                                                        <td rowspan="{{ $version == 1 ? 3 : ($class == 0 ? 5 : 6) }}"
                                                        ...
                                                        <td rowspan="{{ $version == 1 ? 1 : ($class == 0 ? 2 : 3) }}"
