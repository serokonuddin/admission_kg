...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Dashboard /</span> Merit Position
            </h4>
            ...
            <div class="col-md mb-4 mb-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formAccountSettings" method="POST" action="{{ route('saveMeritSecondTimePosition') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-3">
                                    <label for="shift_id" class="form-label">Shift <span style="color: red">*</span></label>
                                ...
                                @if (Auth::user()->is_view_user == 0)
                                    <div class="mb-3  col-md-3">
                                        ...
                                        <button type="button" id="addTotalMark"
                                            class="btn btn-primary form-control me-2 mt-1">Add Merit Position</button>
    ...
    <script>
        ...
        $(function() {
            ...
            $(document.body).on('click', '#addTotalMark', function() {
                var session_id = $('#session_id').val();
                var class_code = $('#class_code').val();
                ...
                var shift_id = $('#shift_id').val();
                var getdata = 0;
                if (session_id && class_code && exam_id && version_id && section_id && class_code >= 4) {
                    $.LoadingOverlay("show");
                    $.ajax({
                        type: "post",
                        headers: {
                ...
                } else if (session_id && class_code && exam_id && version_id && section_id && class_code <
                    4) {
                    $.LoadingOverlay("show");
                    $.ajax({
                        type: "post",
            ...
            $(document.body).on('click', '#search', function() {
                ...
                var exam_id = $('#exam_id').val();
                var getdata = 0;
                if (session_id && exam_id && class_code > 8) {
                    $.LoadingOverlay("show");
                    $.ajax({
                        type: "post",
                        headers: {
                ...
                } else if (session_id && exam_id && class_code < 9 && shift_id) {
                    $.LoadingOverlay("show");
                    $.ajax({
                        type: "post",
                        headers: {
