...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Dashboard /</span>CT Quiz Mark Upload
            </h4>
            @php
            ...
            <div class="col-md mb-4 mb-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formAdmission" method="POST" action="{{ route('subject_marks_ct_upload_xl') }}"
                                    ...
                                    <select id="session_id" name="session_id" class=" form-select" required="">
                                        ...
                                        @foreach ($sessions as $session)
                                            <option value="{{ $session->id }}"
                                                ...
                                                {{ $session->college_session }}</option>
                                        @endforeach
    ...
    @endforeach
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select id="class_code" name="class_code" class=" form-select" required="">
                                        ...
                                        <option value="11" {{ $class_code == 11 ? 'selected="selected"' : '' }}>CLass XI
                                        </option>
                                        <option value="12" {{ $class_code == 12 ? 'selected="selected"' : '' }}>CLass
                                            XII
                                        </option>
    ...
    @endforeach
                                    ...
                                    <select id="exam_id" name="exam_id" class=" form-select" required="">
                                        ...
                                        @foreach ($exams as $exam)
                                            <option value="{{ $exam->id }}"
                                                {{ $exam_id == $exam->id ? 'selected="selected"' : '' }}>
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="xl_type" class="form-label">XL For <span
                                            style="color: red">*</span></label>
                                    <select id="xl_type" name="xl_type" class=" form-select" required="">
                                        <option value="">XL For</option>
                                        <option {{ $xl_type == 1 ? 'selected="selected"' : '' }} value="1">CT-Quiz
                                        </option>
                                        <option {{ $xl_type == 2 ? 'selected="selected"' : '' }} value="2">CQ-MCQ
                                        </option>
                                    </select>
                                </div>

                                <div class="mb-3 col-md-4">
                                    <label for="subject_id" class="form-label">XL File <span
                                            style="color: red">*</span></label>
                                ...
                                @if (Auth::user()->is_view_user == 0)
                                    <div class="mb-3  col-md-2">
                                        ...
                                        <button type="submit" id="upload"
                                            class="btn btn-primary form-control me-2 mt-1">upload</button>
                                    ...
                                    <div class="mb-3  col-md-2">
                                        ...
                                        <button type="button" id="searchtop"
                                            class="btn btn-info form-control me-2 mt-1">Search</button>
                                    </div>
                                @endif
    ...
    <script>
        $(function() {
            $(document.body).on('click', '#searchtop', function() {
                ...
                var xl_type = $('#xl_type').val();
                var session_id = $('#session_id').val();
                var section_id = $('#section_id').val();
                var class_code = $('#class_code').val();
                var subject_id = $('#subject_id').val();
                var url = "{{ route('getsubjectMark1112') }}";
                $.LoadingOverlay("show");
                $.ajax({
                    type: "post",
                    headers: {
