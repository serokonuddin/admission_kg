        ...
        <tr>
            ...
            @foreach ($subject->subjectMarkTerms as $term)
                ...
                @elseif($term->marks_for == 1)
                    {{ $class_code > 5 && $class_code != 10 ? 'Summative Assesment (SA)' : 'CQ' }}
            ...
            @foreach ($subject->subjectMarkTerms as $term)
                @if ($term->marks_for == 0)
                    ...
                    @else
                        ...
                        <th class="{{ $class_code >= 4 && $class_code <= 5 ? 'none' : '' }}">Project <br />Proposal
                        </th>
    ...
    <tbody>
        @foreach ($students as $student)
            ...
            <tr class="{{ $is_absentclass == 1 ? 'isabsent' : '' }}">
                        ...
                        @if ($term->marks_for == 0)
                            ...
                            <td>
                                ...
                                <input class="form-control marks ct3   text-center " step="1"
                                    ...
                                    id="ct3{{ $student->student_code }}"
                                    data-student_code="{{ $student->student_code }}"
                                    data-maxvalue="{{ $max_work }}" data-minvalue="{{ $term->pass_mark }}"
                                    data-marks_for="" type="number">
                            </td>
                            <td>

                                <input class="form-control marks ct4   text-center " step="1"
                                    value="{{ $subjectmark->ct4 ?? '' }}" name="ct4{{ $student->student_code }}"
                                    id="ct4{{ $student->student_code }}"
                                    data-student_code="{{ $student->student_code }}"
                                    data-maxvalue="{{ $max_work }}" data-minvalue="{{ $term->pass_mark }}"
                                    data-marks_for="" type="number">
                            </td>
                            <td>
                                ...
                                <input readonly="" class="form-control marks ct   text-center " step="1"
                                    ...
                                    id="ct{{ $student->student_code }}"
                                    data-student_code="{{ $student->student_code }}" data-marks_for="ct"
                                    type="number">
                            </td>
                            @php
                        ...
                        @if ($term->marks_for == 0)
                            <td>
                                ...
                                <input class="form-control marks ct1   text-center " step="1"
                                    ...
                                    id="ct1{{ $student->student_code }}"
                                    data-student_code="{{ $student->student_code }}"
                                    data-maxvalue="{{ $max_assigment }}" data-marks_for="" type="number">
                            </td>
                            <td>
                                <input class="form-control marks ct2   text-center " step="1"
                                    value="{{ $subjectmark->ct2 ?? '' }}" name="ct2{{ $student->student_code }}"
                                    id="ct2{{ $student->student_code }}"
                                    data-student_code="{{ $student->student_code }}"
                                    data-maxvalue="{{ $max_project }}" data-marks_for="" type="number">
                            </td>
                            ...
                            <td>
                                ...
                                <input class="form-control marks ct3   text-center " step="1"
                                    ...
                                    id="ct3{{ $student->student_code }}"
                                    data-student_code="{{ $student->student_code }}"
                                    data-maxvalue="{{ $max_work }}" data-marks_for="" type="number">
                            </td>
                            <td>
                    ...
                    @elseif($class_code == 4 || $class_code == 5)
                        @if ($term->marks_for == 0)
                            ...
                            <td>
                                ...
                                <input class="form-control marks ct   text-center " step="1"
                                    value="{{ $subjectmark->ct ?? '' }}" name="ct{{ $student->student_code }}"
                                    id="ct{{ $student->student_code }}"
                                    data-student_code="{{ $student->student_code }}"
                                    data-maxvalue="{{ $term->total_mark }}" data-marks_for="ct" type="number">
                            </td>
                            @php
                                $total_mark_cq += $subjectmark->ct ?? 0;
                            @endphp
                        @else
                            @php
                                ...
                                if ($term->marks_for == 1) {
                                    ...
                                    if ($subjectmark && $subjectmark->cq_total < $term->pass_mark) {
                                        $isnegative = -1;
                                    }
                                } elseif ($term->marks_for == 2) {
                                    $obtained = $subjectmark?->mcq ?? '';
                                    ...
                                    $total = $subjectmark?->mcq_total ?? '';
                                    $total_mark += $subjectmark?->mcq_total ?? 0;
                                    if ($subjectmark && $subjectmark->mcq_total < $term->pass_mark) {
                                        $isnegative = -1;
                                    }
                                } else {
                                    $obtained = $subjectmark?->practical ?? '';
                                    ...
                                    $total = $subjectmark?->practical_total ?? '';
                                    $total_mark += $subjectmark?->practical_total ?? 0;
                                    if ($subjectmark && $subjectmark->practical_total < $term->pass_mark) {
                                        $isnegative = -1;
                                    }
                                }
                            @endphp
                            ...
                            <td>
                                ...
                                <input class="form-control marks    text-center " step="1" readonly=""
                                    value="{{ $total }}"
                                    name="totalmark{{ $term->marks_for }}{{ $student->student_code }}"
                                    id="totalmark{{ $term->marks_for }}{{ $student->student_code }}"
                                    data-maxvalue="{{ $term->total_mark }}" data-minvalue="{{ $term->pass_mark }}"
                ...
                <td>
                    <input class="form-control marks    text-center " readonly=""
                        value="{{ $total_mark ?? '' }}" name="totalmark{{ $student->student_code }}"
...
<script>
    ...
    $(document).ready(function() {
        ...
        function calculateSums() {
            ...
            @if ($class_code == 4 || $class_code == 5)
                let sum1 = Num($('input[name="ct' + student_code + '"]').val());
            @elseif ($class_code == 11 || $class_code == 12)
                ...
                let ct4 = Num($('input[name="ct4' + student_code + '"]').val());
                let sum1 = ct1 + ct2 + ct3 + ct4;
                sum1 = Math.round((Number(sum1) * 30) / 80);
                console.log(sum1);
