...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4">
          <span class="text-muted fw-light">Dashboard /</span> Emis Charge
       </h4>

          <div class="col-md mb-4 mb-md-0">
             <div class="card">
                <h5 class="card-header">Emis Charge List</h5>
                <div class="table-responsive text-nowrap fixed">
                   @if(Auth::user()->getMenu('emisCharge.store','name') || Auth::user()->group_id==2)
                   <form  method="post" action="{{route('emisCharge.store')}}"  novalidate="" id="formsubmit">
                    @csrf
                    <input type="hidden" value="34" name="head_id" />
                   <div class="row">
