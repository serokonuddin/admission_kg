...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Outstanding Tuition Fee</h4>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="card">
                     ...
                     <form id="formAccountSettings" method="POST" action="{{route('outstandingTuitionFee')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <small class="text-light fw-medium d-block">Outstandine Tuition Fee</small>
                            <div class="row">
 ...
 <script>
    $(function(){
        $(document.body).on('click', '#searchtop',function(){
            ...
            var class_id=$('#class_id').val();
                location.href="{{route('outstandingTuitionFee')}}"+'?version_id='+version_id+'& class_id='+class_id;
    ...
    var url="{{route('outstandingTuitionFee')}}";
