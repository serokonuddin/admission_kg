...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Board Fee</h4>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="card">
                     ...
                     <form id="formAccountSettings" method="POST" action="{{route('boardFee.store')}}" enctype="multipart/form-data">
                        <input type="hidden" value="0" name="id" id="id" />
                        <input type="hidden" value="6" name="fee_for" id="fee_for" />
                        <input type="hidden" value="Board Fee" name="feefor" id="feefor" />
                            @csrf
                            <div class="row">
                                ...
                                @php
                                    ...
                                    <input type="hidden" value="37" name="head_id[]"  />
                                    <div class="row mb-3 col-md-4">
                                        <label class="col-sm-3 col-form-label" for="basic-default-name">Board Fee</label>
                                        <div class="col-sm-9">
                                        <input type="text" id="amount37" name="amount37" class="form-control" placeholder="Board Fee amount">
                                        </div>
                                    </div>
                        ...
                        <div class="row" style="margin-bottom: 10px;margin-top: 20px;">
                            <small class="text-light fw-medium d-block">Board Fee</small>
                            @php
