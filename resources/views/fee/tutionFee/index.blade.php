...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Tution Fee</h4>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="card">
                     ...
                     <form id="formAccountSettings" method="POST" action="{{route('tutionFee.store')}}" enctype="multipart/form-data">
                        <input type="hidden" value="0" name="id" id="id" />
                        <input type="hidden" value="3" name="fee_for" id="fee_for" />
                        <input type="hidden" value="Tuition Fee" name="feefor" id="feefor" />
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="row mb-3 col-md-4">
                                        <label class="col-sm-4 col-form-label" for="basic-default-name">Version</label>
                                        <div class="col-sm-8">
                                ...
                                @php
                                    ...
                                    <div class="row mb-3 col-md-4">
                                        ...
                                        <option value="{{$category->id}}" {{(isset($categoryhead) && $categoryhead->category_id==$category->category_id)?'selected="selected"':''}}>{{$category->category_name}}</option>
                                        @endforeach
                                        </select>
                                        </div>
                                    </div>
                                    <div class="row mb-3 col-md-4">
                                        <label class="col-sm-4 col-form-label" for="basic-default-name">Effective Date</label>
                                        <div class="col-sm-8">
                                        <input type="date" id="effective_from" name="effective_from" class="form-control" placeholder="Effective Date">
                                        </div>
                                    </div>

                                    <input type="hidden" value="1" name="head_id[]"  />
                                    <div class="row mb-3 col-md-4">
                                        <label class="col-sm-4 col-form-label" for="basic-default-name">Tution Fee</label>
                                        <div class="col-sm-8">
                                        <input type="text" id="amount1" name="amount1" class="form-control" placeholder="Tution Fee amount">
                                        </div>
                                    </div>
                                    <div class="row mb-3 col-md-2">

                                        <div class="col-sm-12">
                                        <button type="submit" id="submit" class="btn btn-primary form-control me-2">Save</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row" style="margin-bottom: 10px;margin-top: 20px;">
                            <small class="text-light fw-medium d-block">Tution Fee</small>
                            @php
                                    ...
                                    <tr id="id{{$payment->id}}">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                data-effective_from="{{$payment->effective_from}}"
...
$(function() {
      ...
      $(document.body).on('click','.downloadxl',function() {
        ...
        $.ajax({
                ...
                url: url,
                data:{"_token": "{{ csrf_token() }}",month,effective_from,fee_for,session_id,version_id,class_code,category_id,gender,feefor,session,version,classes,category,'xltext':'tuitionFee'},
                xhrFields: {
                ...
                success: function(data, status, xhr) {
                    ...
                    link.download = 'tuitionFee.xlsx'; // The name of the downloaded file
