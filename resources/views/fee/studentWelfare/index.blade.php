...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Student Welfare Fee</h4>
               ...
               <div class="col-md-12">
                  ...
                  <div class="card">
                     ...
                     <form id="formAccountSettings" method="POST" action="{{route('tutionFee.store')}}" enctype="multipart/form-data">
                        ...
                        <input type="hidden" value="9" name="fee_for" id="fee_for" />
                        <input type="hidden" value="Student Welfare Fee" name="feefor" id="feefor" />
                            @csrf
                            <div class="row">
                                ...
                                @php
                                    ...
                                    <input type="hidden" value="29" name="head_id[]"  />
                                    <div class="row mb-3 col-md-4">
                                        <label class="col-sm-4 col-form-label" for="basic-default-name">Student Welfare Fee</label>
                                        <div class="col-sm-8">
                                        <input type="text" id="amount1" name="amount1" class="form-control" placeholder="Student Welfare Fee amount">
                                        </div>
                                    </div>
                        ...
                        <div class="row" style="margin-bottom: 10px;margin-top: 20px;">
                            <small class="text-light fw-medium d-block">Student Welfare Fee</small>
