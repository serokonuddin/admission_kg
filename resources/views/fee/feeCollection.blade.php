...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Fee Collection</h4>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="card">
                     ...
                     <form id="formAccountSettings" method="POST" action="{{route('feeCollection')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select id="fee_id" name="fee_id" class=" form-select" required="">
                                    <option value="">Select Fee</option>
                                    @foreach($fees as $fee)
                                    <option value="{{$fee->id}}" {{($fee_id==$fee->id)?'selected="selected"':''}}>{{$fee->head_name}}</option>
                                    @endforeach
                            ...
                            <small class="text-light fw-medium d-block">Fee Collection</small>
                            <div class="row">
    ...
    $(function(){
        ...
        $(document.body).on('click', '#searchtop',function(){
            ...
            var fee_id=$('#fee_id').val();
                location.href="{{route('feeCollection')}}"+'?fee_id='+fee_id+' &version_id='+version_id+'&class_id='+class_id+'&end_date='+end_date+'&start_date='+start_date;
