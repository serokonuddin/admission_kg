...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Session Charge</h4>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="formAccountSettings" method="POST" action="{{ route('sessionCharge.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mb-3 col-md-4">
                                        <label class="col-sm-5 col-form-label" for="basic-default-name">Category</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="row mb-3 col-md-4">
                                        ...
                                        <div class="col-sm-7">
                                            <select id="month" name="month" class=" form-select" required="">
                                                <option value="01"
                                                    {{ isset($categoryhead) && $categoryhead->month == '01' ? 'selected="selected"' : '' }}>
                                                    January</option>
                                                <option value="02"
                                                    {{ isset($categoryhead) && $categoryhead->month == '02' ? 'selected="selected"' : '' }}>
                                                    February</option>
                                                <option value="03"
                                                    {{ isset($categoryhead) && $categoryhead->month == '03' ? 'selected="selected"' : '' }}>
                                                    March</option>
                                                <option value="04"
                                                    {{ isset($categoryhead) && $categoryhead->month == '04' ? 'selected="selected"' : '' }}>
                                                    April</option>
                                                <option value="05"
                                                    {{ isset($categoryhead) && $categoryhead->month == '05' ? 'selected="selected"' : '' }}>
                                                    May</option>
                                                <option value="06"
                                                    {{ isset($categoryhead) && $categoryhead->month == '06' ? 'selected="selected"' : '' }}>
                                                    June</option>
                                                <option value="07"
                                                    {{ isset($categoryhead) && $categoryhead->month == '07' ? 'selected="selected"' : '' }}>
                                                    July</option>
                                                <option value="08"
                                                    {{ isset($categoryhead) && $categoryhead->month == '08' ? 'selected="selected"' : '' }}>
                                                    August</option>
                                                <option value="09"
                                                    {{ isset($categoryhead) && $categoryhead->month == '09' ? 'selected="selected"' : '' }}>
                                                    September</option>
                                                <option value="10"
                                                    {{ isset($categoryhead) && $categoryhead->month == '10' ? 'selected="selected"' : '' }}>
                                                    October</option>
                                                <option value="11"
                                                    {{ isset($categoryhead) && $categoryhead->month == '11' ? 'selected="selected"' : '' }}>
                                                    November</option>
                                                <option value="12"
                                                    {{ isset($categoryhead) && $categoryhead->month == '12' ? 'selected="selected"' : '' }}>
                                                    December</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    @foreach ($fees as $fee)
                                        <div class="row mb-3 col-md-4">
                                            <label class="col-sm-5 col-form-label" for="basic-default-name">
                                                <input type="checkbox" name="head_id[]" value="{{ $fee->id }}"
                                                    class="form-check-input"> {{ $fee->head_name }}
                                            </label>
                                            <div class="col-sm-7">
                                                <input type="text" id="amount{{ $fee->id }}"
                                                    name="amount{{ $fee->id }}" class="form-control"
                                                    placeholder="{{ $fee->head_name }} amount">
                                            </div>
                                        </div>
                                    @endforeach
                            ...
                            <div class="row" style="margin-bottom: 10px;margin-top: 20px;">
                                <small class="text-light fw-medium d-block">Session Charge</small>
                                @php
                                    $month = [
                                        '01' => 'January',
                                        '02' => 'February',
            ...
            $(document.body).on('click', '.downloadxl', function() {
                ...
                $.ajax({
                    ...
                    success: function(data, status, xhr) {
                        ...
                        link.download = 'sessionCharge.xlsx'; // The name of the downloaded file
